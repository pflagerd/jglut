...
JNIEXPORT void JNICALL Java_com_pflager_gl_glRasterPos3iv(JNIEnv *env, jobject object, jintArray vJIntArray) {
    DPRINTF("glRasterPos3iv(%p);\n", vJIntArray);
    ...
    glRasterPos3iv(jintArrayElements);
