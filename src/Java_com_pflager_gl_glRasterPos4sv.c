...
JNIEXPORT void JNICALL Java_com_pflager_gl_glRasterPos4sv(JNIEnv *env, jobject object, jshortArray vJShortArray) {
    DPRINTF("glRasterPos4sv(%p);\n", vJShortArray);
    ...
    glRasterPos4sv(jshortArrayElements);
