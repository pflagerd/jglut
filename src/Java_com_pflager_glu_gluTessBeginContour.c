...
JNIEXPORT void JNICALL Java_com_pflager_glu_gluTessBeginContour(JNIEnv *env, jobject object, jobject tessJObject) {
    DPRINTF("gluTessBeginContour(%p);\n", tessJObject);
	...
	gluTessBeginContour((GLUtesselator*) glutesselator);
}
