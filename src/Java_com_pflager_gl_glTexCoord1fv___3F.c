...
JNIEXPORT void JNICALL Java_com_pflager_gl_glTexCoord1fv___3F(JNIEnv *env, jobject object, jfloatArray vJFloatArray) {
    DPRINTF("glTexCoord1fv(%p);\n", vJFloatArray);
    ...
    glTexCoord1fv(jfloatArrayElements);
