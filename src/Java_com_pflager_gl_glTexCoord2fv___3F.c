...
JNIEXPORT void JNICALL Java_com_pflager_gl_glTexCoord2fv___3F(JNIEnv *env, jobject object, jfloatArray vJFloatArray) {
    DPRINTF("glTexCoord2fv(%p);\n", vJFloatArray);
    ...
    glTexCoord2fv(jfloatArrayElements);
