...
JNIEXPORT void JNICALL Java_com_pflager_gl_glTexCoord2iv(JNIEnv *env, jobject object, jintArray vJIntArray) {
    DPRINTF("glTexCoord2iv(%p);\n", vJIntArray);
    ...
    glTexCoord2iv(jintArrayElements);
