...
JNIEXPORT void JNICALL Java_com_pflager_glu_gluQuadricNormals(JNIEnv *env, jobject object, jobject quadJObject, jint normalJInt) {
    DPRINTF("gluQuadricNormals(%p, %d);\n", quadJObject, normalJInt);
    ...
    gluQuadricNormals((GLUquadric*)quadJObject, normalJInt);
