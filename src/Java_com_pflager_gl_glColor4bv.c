...
JNIEXPORT void JNICALL Java_com_pflager_gl_glColor4bv(JNIEnv *env, jobject object, jbyteArray vJByteArray) {
    DPRINTF("glColor4bv(%p);\n", vJByteArray);
