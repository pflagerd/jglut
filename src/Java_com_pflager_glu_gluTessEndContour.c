...
JNIEXPORT void JNICALL Java_com_pflager_glu_gluTessEndContour(JNIEnv *env, jobject object, jobject tessJObject) {
    DPRINTF("gluTessEndContour(%p);\n", tessJObject);
	...
	gluTessEndContour((GLUtesselator*) glutesselator);
}
