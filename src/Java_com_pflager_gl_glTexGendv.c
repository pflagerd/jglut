...
JNIEXPORT void JNICALL Java_com_pflager_gl_glTexGendv(JNIEnv *env, jobject object, jint coordJInt, jint pnameJInt, jdoubleArray paramsJDoubleArray) {
    DPRINTF("glTexGendv(%d, %d, %p);\n", coordJInt, pnameJInt, paramsJDoubleArray);
