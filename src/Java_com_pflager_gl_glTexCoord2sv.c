...
JNIEXPORT void JNICALL Java_com_pflager_gl_glTexCoord2sv(JNIEnv *env, jobject object, jshortArray vJShortArray) {
    DPRINTF("glTexCoord2sv(%p);\n", vJShortArray);
    ...
    glTexCoord2sv(jshortArrayElements);
