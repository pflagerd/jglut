...
JNIEXPORT void JNICALL Java_com_pflager_gl_glTexCoord4sv(JNIEnv *env, jobject object, jshortArray vJShortArray) {
    DPRINTF("glTexCoord4sv(%p);\n", vJShortArray);
    ...
    glTexCoord4sv(jshortArrayElements);
