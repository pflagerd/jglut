...
JNIEXPORT void JNICALL Java_com_pflager_glu_gluBeginSurface(JNIEnv *env, jobject object, jobject nurbJObject) {
    DPRINTF("gluBeginSurface(%p);\n", nurbJObject);
    ...
    gluBeginSurface((GLUnurbs*)glunurbs);
}
