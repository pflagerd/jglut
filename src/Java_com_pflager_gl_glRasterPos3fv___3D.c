...
JNIEXPORT void JNICALL Java_com_pflager_gl_glRasterPos3fv___3D(JNIEnv *env, jobject object, jdoubleArray vJDoubleArray) {
    DPRINTF("glRasterPos3fv(%p);\n", vJDoubleArray);
    ...
    glRasterPos3dv(jdoubleArrayElements);
