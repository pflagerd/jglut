...
JNIEXPORT void JNICALL Java_com_pflager_gl_glTexCoord4fv___3D(JNIEnv *env, jobject object, jdoubleArray vJDoubleArray) {
    DPRINTF("glTexCoord4fv(%p);\n", vJDoubleArray);
    ...
    glTexCoord4dv(jdoubleArrayElements);
