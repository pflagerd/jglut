...
JNIEXPORT void JNICALL Java_com_pflager_gl_glRectdv(JNIEnv *env, jobject object, jdoubleArray v1JDoubleArray, jdoubleArray v2JDoubleArray) {
    DPRINTF("glRectdv(%p, %p);\n", v1JDoubleArray, v2JDoubleArray);
    ...
    (*env)->ReleaseDoubleArrayElements(env, v2JDoubleArray, (double*)v2JDoubleCArray, 0); // release resources
    (*env)->ReleaseDoubleArrayElements(env, v1JDoubleArray, (double*)v1JDoubleCArray, 0); // release resources
}
