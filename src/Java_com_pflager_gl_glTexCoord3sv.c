...
JNIEXPORT void JNICALL Java_com_pflager_gl_glTexCoord3sv(JNIEnv *env, jobject object, jshortArray vJShortArray) {
    DPRINTF("glTexCoord3sv(%p);\n", vJShortArray);
    ...
    glTexCoord3sv(jshortArrayElements);
