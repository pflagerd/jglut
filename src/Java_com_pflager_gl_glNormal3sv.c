...
JNIEXPORT void JNICALL Java_com_pflager_gl_glNormal3sv(JNIEnv *env, jobject object, jshortArray vJShortArray) {
    DPRINTF("glNormal3sv(%p);\n", vJShortArray);
    ...
    glNormal3sv(jshortArrayElements);
