...
JNIEXPORT void JNICALL Java_com_pflager_glu_gluEndCurve(JNIEnv *env, jobject object, jobject nurbJObject) {
    DPRINTF("gluEndCurve(%p);\n", nurbJObject);
