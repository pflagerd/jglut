...
JNIEXPORT void JNICALL Java_com_pflager_gl_glNormal3iv(JNIEnv *env, jobject object, jintArray vJIntArray) {
    DPRINTF("glNormal3iv(%p);\n", vJIntArray);
