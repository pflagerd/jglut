...
JNIEXPORT void JNICALL Java_com_pflager_gl_glColor4sv(JNIEnv *env, jobject object, jshortArray vJShortArray) {
    DPRINTF("glColor4sv(%p);\n", vJShortArray);
    ...
    glColor4sv(jshortArrayElements);
