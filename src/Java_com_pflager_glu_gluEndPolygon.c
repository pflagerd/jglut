...
JNIEXPORT void JNICALL Java_com_pflager_glu_gluEndPolygon(JNIEnv *env, jobject object, jobject tessJObject) {
    DPRINTF("gluEndPolygon(%p);\n", tessJObject);
    ...
    gluEndPolygon((GLUtesselator*)glutesselator);
}
