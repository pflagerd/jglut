...
JNIEXPORT void JNICALL Java_com_pflager_gl_glTexCoord3fv___3F(JNIEnv *env, jobject object, jfloatArray vJFloatArray) {
    DPRINTF("glTexCoord3fv(%p);\n", vJFloatArray);
    ...
    glTexCoord3fv(jfloatArrayElements);
