...
JNIEXPORT void JNICALL Java_com_pflager_glu_gluDeleteTess(JNIEnv *env, jobject object, jobject tessJObject) {
    DPRINTF("gluDeleteTess(%p);\n", tessJObject);
    ...
    gluDeleteTess((GLUtesselator*)glutesselator);
}
