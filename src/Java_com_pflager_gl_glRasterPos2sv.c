...
JNIEXPORT void JNICALL Java_com_pflager_gl_glRasterPos2sv(JNIEnv *env, jobject object, jshortArray vJShortArray) {
    DPRINTF("glRasterPos2sv(%p);\n", vJShortArray);
    ...
    glRasterPos2sv(jshortArrayElements);
