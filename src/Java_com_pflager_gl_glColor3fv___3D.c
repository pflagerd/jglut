...
JNIEXPORT void JNICALL Java_com_pflager_gl_glColor3fv___3D(JNIEnv *env, jobject object, jdoubleArray vJDoubleArray) {
    DPRINTF("glColor3fv(%p);\n", vJDoubleArray);
    ...
    glColor3dv(jdoubleArrayElements);
