...
JNIEXPORT void JNICALL Java_com_pflager_gl_glRasterPos3sv(JNIEnv *env, jobject object, jshortArray vJShortArray) {
    DPRINTF("glRasterPos3sv(%p);\n", vJShortArray);
    ...
    glRasterPos3sv(jshortArrayElements);
