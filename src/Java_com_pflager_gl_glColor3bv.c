...
JNIEXPORT void JNICALL Java_com_pflager_gl_glColor3bv(JNIEnv *env, jobject object, jbyteArray vJByteArray) {
    DPRINTF("glColor3bv(%p);\n", vJByteArray);
