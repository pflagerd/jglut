...
JNIEXPORT void JNICALL Java_com_pflager_gl_glRasterPos4iv(JNIEnv *env, jobject object, jintArray vJIntArray) {
    DPRINTF("glRasterPos4iv(%p);\n", vJIntArray);
    ...
    glRasterPos4iv(jintArrayElements);
