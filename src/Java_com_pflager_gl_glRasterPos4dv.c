...
JNIEXPORT void JNICALL Java_com_pflager_gl_glRasterPos4dv(JNIEnv *env, jobject object, jdoubleArray vJDoubleArray) {
    DPRINTF("glRasterPos4dv(%p);\n", vJDoubleArray);
    ...
    glRasterPos4dv(jdoubleArrayElements);
