...
public class gl {
	...
	public static byte[] flatten(byte[][] in) {
	...
	public static short[] flatten(short[][] in) {
	...
	/* Data types */
	public final int GL_BYTE = 0x00001400;
	public final int GL_UNSIGNED_BYTE = 0x00001401;
	public final int GL_SHORT = 0x00001402;
	public final int GL_UNSIGNED_SHORT = 0x00001403;
	public final int GL_INT = 0x00001404;
	public final int GL_UNSIGNED_INT = 0x00001405;
	public final int GL_FLOAT = 0x00001406;
	public final int GL_2_BYTES = 0x00001407;
	public final int GL_3_BYTES = 0x00001408;
	public final int GL_4_BYTES = 0x00001409;
	public final int GL_DOUBLE = 0x0000140A;

	/* Primitives */
	public final int GL_POINTS = 0x00000000;
	public final int GL_LINES = 0x00000001;
	public final int GL_LINE_LOOP = 0x00000002;
	public final int GL_LINE_STRIP = 0x00000003;
	public final int GL_TRIANGLES = 0x00000004;
	public final int GL_TRIANGLE_STRIP = 0x00000005;
	public final int GL_TRIANGLE_FAN = 0x00000006;
	public final int GL_QUADS = 0x00000007;
	public final int GL_QUAD_STRIP = 0x00000008;
	public final int GL_POLYGON = 0x00000009;

	/* Vertex Arrays */
	public final int GL_VERTEX_ARRAY = 0x00008074;
	public final int GL_NORMAL_ARRAY = 0x00008075;
	public final int GL_COLOR_ARRAY = 0x00008076;
	public final int GL_INDEX_ARRAY = 0x00008077;
	public final int GL_TEXTURE_COORD_ARRAY = 0x00008078;
	public final int GL_EDGE_FLAG_ARRAY = 0x00008079;
	public final int GL_VERTEX_ARRAY_SIZE = 0x0000807A;
	public final int GL_VERTEX_ARRAY_TYPE = 0x0000807B;
	public final int GL_VERTEX_ARRAY_STRIDE = 0x0000807C;
	public final int GL_NORMAL_ARRAY_TYPE = 0x0000807E;
	public final int GL_NORMAL_ARRAY_STRIDE = 0x0000807F;
	public final int GL_COLOR_ARRAY_SIZE = 0x00008081;
	public final int GL_COLOR_ARRAY_TYPE = 0x00008082;
	public final int GL_COLOR_ARRAY_STRIDE = 0x00008083;
	public final int GL_INDEX_ARRAY_TYPE = 0x00008085;
	public final int GL_INDEX_ARRAY_STRIDE = 0x00008086;
	public final int GL_TEXTURE_COORD_ARRAY_SIZE = 0x00008088;
	public final int GL_TEXTURE_COORD_ARRAY_TYPE = 0x00008089;
	public final int GL_TEXTURE_COORD_ARRAY_STRIDE = 0x0000808A;
	public final int GL_EDGE_FLAG_ARRAY_STRIDE = 0x0000808C;
	public final int GL_VERTEX_ARRAY_POINTER = 0x0000808E;
	public final int GL_NORMAL_ARRAY_POINTER = 0x0000808F;
	public final int GL_COLOR_ARRAY_POINTER = 0x00008090;
	public final int GL_INDEX_ARRAY_POINTER = 0x00008091;
	public final int GL_TEXTURE_COORD_ARRAY_POINTER = 0x00008092;
	public final int GL_EDGE_FLAG_ARRAY_POINTER = 0x00008093;
	public final int GL_V2F = 0x00002A20;
	public final int GL_V3F = 0x00002A21;
	public final int GL_C4UB_V2F = 0x00002A22;
	public final int GL_C4UB_V3F = 0x00002A23;
	public final int GL_C3F_V3F = 0x00002A24;
	public final int GL_N3F_V3F = 0x00002A25;
	public final int GL_C4F_N3F_V3F = 0x00002A26;
	public final int GL_T2F_V3F = 0x00002A27;
	public final int GL_T4F_V4F = 0x00002A28;
	public final int GL_T2F_C4UB_V3F = 0x00002A29;
	public final int GL_T2F_C3F_V3F = 0x00002A2A;
	public final int GL_T2F_N3F_V3F = 0x00002A2B;
	public final int GL_T2F_C4F_N3F_V3F = 0x00002A2C;
	public final int GL_T4F_C4F_N3F_V4F = 0x00002A2D;

	/* Matrix Mode */
	public final int GL_MATRIX_MODE = 0x00000BA0;
	public final int GL_MODELVIEW = 0x00001700;
	public final int GL_PROJECTION = 0x00001701;
	public final int GL_TEXTURE = 0x00001702;

	/* Points */
	public final int GL_POINT_SMOOTH = 0x00000B10;
	public final int GL_POINT_SIZE = 0x00000B11;
	public final int GL_POINT_SIZE_GRANULARITY = 0x00000B13;
	public final int GL_POINT_SIZE_RANGE = 0x00000B12;

	/* Lines */
	public final int GL_LINE_SMOOTH = 0x00000B20;
	public final int GL_LINE_STIPPLE = 0x00000B24;
	public final int GL_LINE_STIPPLE_PATTERN = 0x00000B25;
	public final int GL_LINE_STIPPLE_REPEAT = 0x00000B26;
	public final int GL_LINE_WIDTH = 0x00000B21;
	public final int GL_LINE_WIDTH_GRANULARITY = 0x00000B23;
	public final int GL_LINE_WIDTH_RANGE = 0x00000B22;

	/* Polygons */
	public final int GL_POINT = 0x00001B00;
	public final int GL_LINE = 0x00001B01;
	public final int GL_FILL = 0x00001B02;
	public final int GL_CW = 0x00000900;
	public final int GL_CCW = 0x00000901;
	public final int GL_FRONT = 0x00000404;
	public final int GL_BACK = 0x00000405;
	public final int GL_POLYGON_MODE = 0x00000B40;
	public final int GL_POLYGON_SMOOTH = 0x00000B41;
	public final int GL_POLYGON_STIPPLE = 0x00000B42;
	public final int GL_EDGE_FLAG = 0x00000B43;
	public final int GL_CULL_FACE = 0x00000B44;
	public final int GL_CULL_FACE_MODE = 0x00000B45;
	public final int GL_FRONT_FACE = 0x00000B46;
	public final int GL_POLYGON_OFFSET_FACTOR = 0x00008038;
	public final int GL_POLYGON_OFFSET_UNITS = 0x00002A00;
	public final int GL_POLYGON_OFFSET_POINT = 0x00002A01;
	public final int GL_POLYGON_OFFSET_LINE = 0x00002A02;
	public final int GL_POLYGON_OFFSET_FILL = 0x00008037;

	/* Display Lists */
	public final int GL_COMPILE = 0x00001300;
	public final int GL_COMPILE_AND_EXECUTE = 0x00001301;
	public final int GL_LIST_BASE = 0x00000B32;
	public final int GL_LIST_INDEX = 0x00000B33;
	public final int GL_LIST_MODE = 0x00000B30;

	/* Depth buffer */
	public final int GL_NEVER = 0x00000200;
	public final int GL_LESS = 0x00000201;
	public final int GL_EQUAL = 0x00000202;
	public final int GL_LEQUAL = 0x00000203;
	public final int GL_GREATER = 0x00000204;
	public final int GL_NOTEQUAL = 0x00000205;
	public final int GL_GEQUAL = 0x00000206;
	public final int GL_ALWAYS = 0x00000207;
	public final int GL_DEPTH_TEST = 0x00000B71;
	public final int GL_DEPTH_BITS = 0x00000D56;
	public final int GL_DEPTH_CLEAR_VALUE = 0x00000B73;
	public final int GL_DEPTH_FUNC = 0x00000B74;
	public final int GL_DEPTH_RANGE = 0x00000B70;
	public final int GL_DEPTH_WRITEMASK = 0x00000B72;
	public final int GL_DEPTH_COMPONENT = 0x00001902;

	/* Lighting */
	public final int GL_LIGHTING = 0x00000B50;
	public final int GL_LIGHT0 = 0x00004000;
	public final int GL_LIGHT1 = 0x00004001;
	public final int GL_LIGHT2 = 0x00004002;
	public final int GL_LIGHT3 = 0x00004003;
	public final int GL_LIGHT4 = 0x00004004;
	public final int GL_LIGHT5 = 0x00004005;
	public final int GL_LIGHT6 = 0x00004006;
	public final int GL_LIGHT7 = 0x00004007;
	public final int GL_SPOT_EXPONENT = 0x00001205;
	public final int GL_SPOT_CUTOFF = 0x00001206;
	public final int GL_CONSTANT_ATTENUATION = 0x00001207;
	public final int GL_LINEAR_ATTENUATION = 0x00001208;
	public final int GL_QUADRATIC_ATTENUATION = 0x00001209;
	public final int GL_AMBIENT = 0x00001200;
	public final int GL_DIFFUSE = 0x00001201;
	public final int GL_SPECULAR = 0x00001202;
	public final int GL_SHININESS = 0x00001601;
	public final int GL_EMISSION = 0x00001600;
	public final int GL_POSITION = 0x00001203;
	public final int GL_SPOT_DIRECTION = 0x00001204;
	public final int GL_AMBIENT_AND_DIFFUSE = 0x00001602;
	public final int GL_COLOR_INDEXES = 0x00001603;
	public final int GL_LIGHT_MODEL_TWO_SIDE = 0x00000B52;
	public final int GL_LIGHT_MODEL_LOCAL_VIEWER = 0x00000B51;
	public final int GL_LIGHT_MODEL_AMBIENT = 0x00000B53;
	public final int GL_FRONT_AND_BACK = 0x00000408;
	public final int GL_SHADE_MODEL = 0x00000B54;
	public final int GL_FLAT = 0x00001D00;
	public final int GL_SMOOTH = 0x00001D01;
	public final int GL_COLOR_MATERIAL = 0x00000B57;
	public final int GL_COLOR_MATERIAL_FACE = 0x00000B55;
	public final int GL_COLOR_MATERIAL_PARAMETER = 0x00000B56;
	public final int GL_NORMALIZE = 0x00000BA1;

	/* User clipping planes */
	public final int GL_CLIP_PLANE0 = 0x00003000;
	public final int GL_CLIP_PLANE1 = 0x00003001;
	public final int GL_CLIP_PLANE2 = 0x00003002;
	public final int GL_CLIP_PLANE3 = 0x00003003;
	public final int GL_CLIP_PLANE4 = 0x00003004;
	public final int GL_CLIP_PLANE5 = 0x00003005;

	/* Accumulation buffer */
	public final int GL_ACCUM_RED_BITS = 0x00000D58;
	public final int GL_ACCUM_GREEN_BITS = 0x00000D59;
	public final int GL_ACCUM_BLUE_BITS = 0x00000D5A;
	public final int GL_ACCUM_ALPHA_BITS = 0x00000D5B;
	public final int GL_ACCUM_CLEAR_VALUE = 0x00000B80;
	public final int GL_ACCUM = 0x00000100;
	public final int GL_ADD = 0x00000104;
	public final int GL_LOAD = 0x00000101;
	public final int GL_MULT = 0x00000103;
	public final int GL_RETURN = 0x00000102;

	/* Alpha testing */
	public final int GL_ALPHA_TEST = 0x00000BC0;
	public final int GL_ALPHA_TEST_REF = 0x00000BC2;
	public final int GL_ALPHA_TEST_FUNC = 0x00000BC1;

	/* Blending */
	public final int GL_BLEND = 0x00000BE2;
	public final int GL_BLEND_SRC = 0x00000BE1;
	public final int GL_BLEND_DST = 0x00000BE0;
	public final int GL_ZERO = 0;
	public final int GL_ONE = 1;
	public final int GL_SRC_COLOR = 0x00000300;
	public final int GL_ONE_MINUS_SRC_COLOR = 0x00000301;
	public final int GL_SRC_ALPHA = 0x00000302;
	public final int GL_ONE_MINUS_SRC_ALPHA = 0x00000303;
	public final int GL_DST_ALPHA = 0x00000304;
	public final int GL_ONE_MINUS_DST_ALPHA = 0x00000305;
	public final int GL_DST_COLOR = 0x00000306;
	public final int GL_ONE_MINUS_DST_COLOR = 0x00000307;
	public final int GL_SRC_ALPHA_SATURATE = 0x00000308;

	/* Render Mode */
	public final int GL_FEEDBACK = 0x00001C01;
	public final int GL_RENDER = 0x00001C00;
	public final int GL_SELECT = 0x00001C02;

	/* Feedback */
	public final int GL_2D = 0x00000600;
	public final int GL_3D = 0x00000601;
	public final int GL_3D_COLOR = 0x00000602;
	public final int GL_3D_COLOR_TEXTURE = 0x00000603;
	public final int GL_4D_COLOR_TEXTURE = 0x00000604;
	public final int GL_POINT_TOKEN = 0x00000701;
	public final int GL_LINE_TOKEN = 0x00000702;
	public final int GL_LINE_RESET_TOKEN = 0x00000707;
	public final int GL_POLYGON_TOKEN = 0x00000703;
	public final int GL_BITMAP_TOKEN = 0x00000704;
	public final int GL_DRAW_PIXEL_TOKEN = 0x00000705;
	public final int GL_COPY_PIXEL_TOKEN = 0x00000706;
	public final int GL_PASS_THROUGH_TOKEN = 0x00000700;
	public final int GL_FEEDBACK_BUFFER_POINTER = 0x00000DF0;
	public final int GL_FEEDBACK_BUFFER_SIZE = 0x00000DF1;
	public final int GL_FEEDBACK_BUFFER_TYPE = 0x00000DF2;

	/* Selection */
	public final int GL_SELECTION_BUFFER_POINTER = 0x00000DF3;
	public final int GL_SELECTION_BUFFER_SIZE = 0x00000DF4;

	/* Fog */
	public final int GL_FOG = 0x00000B60;
	public final int GL_FOG_MODE = 0x00000B65;
	public final int GL_FOG_DENSITY = 0x00000B62;
	public final int GL_FOG_COLOR = 0x00000B66;
	public final int GL_FOG_INDEX = 0x00000B61;
	public final int GL_FOG_START = 0x00000B63;
	public final int GL_FOG_END = 0x00000B64;
	public final int GL_LINEAR = 0x00002601;
	public final int GL_EXP = 0x00000800;
	public final int GL_EXP2 = 0x00000801;

	/* Logic Ops */
	public final int GL_LOGIC_OP = 0x00000BF1;
	public final int GL_INDEX_LOGIC_OP = 0x00000BF1;
	public final int GL_COLOR_LOGIC_OP = 0x00000BF2;
	public final int GL_LOGIC_OP_MODE = 0x00000BF0;
	public final int GL_CLEAR = 0x00001500;
	public final int GL_SET = 0x0000150F;
	public final int GL_COPY = 0x00001503;
	public final int GL_COPY_INVERTED = 0x0000150C;
	public final int GL_NOOP = 0x00001505;
	public final int GL_INVERT = 0x0000150A;
	public final int GL_AND = 0x00001501;
	public final int GL_NAND = 0x0000150E;
	public final int GL_OR = 0x00001507;
	public final int GL_NOR = 0x00001508;
	public final int GL_XOR = 0x00001506;
	public final int GL_EQUIV = 0x00001509;
	public final int GL_AND_REVERSE = 0x00001502;
	public final int GL_AND_INVERTED = 0x00001504;
	public final int GL_OR_REVERSE = 0x0000150B;
	public final int GL_OR_INVERTED = 0x0000150D;

	/* Stencil */
	public final int GL_STENCIL_BITS = 0x00000D57;
	public final int GL_STENCIL_TEST = 0x00000B90;
	public final int GL_STENCIL_CLEAR_VALUE = 0x00000B91;
	public final int GL_STENCIL_FUNC = 0x00000B92;
	public final int GL_STENCIL_VALUE_MASK = 0x00000B93;
	public final int GL_STENCIL_FAIL = 0x00000B94;
	public final int GL_STENCIL_PASS_DEPTH_FAIL = 0x00000B95;
	public final int GL_STENCIL_PASS_DEPTH_PASS = 0x00000B96;
	public final int GL_STENCIL_REF = 0x00000B97;
	public final int GL_STENCIL_WRITEMASK = 0x00000B98;
	public final int GL_STENCIL_INDEX = 0x00001901;
	public final int GL_KEEP = 0x00001E00;
	public final int GL_REPLACE = 0x00001E01;
	public final int GL_INCR = 0x00001E02;
	public final int GL_DECR = 0x00001E03;

	/* Buffers, Pixel Drawing/Reading */
	public final int GL_NONE = 0;
	public final int GL_LEFT = 0x00000406;
	public final int GL_RIGHT = 0x00000407;
	/* GL_FRONT 0x0404 */
	/* GL_BACK 0x0405 */
	/* GL_FRONT_AND_BACK 0x0408 */
	public final int GL_FRONT_LEFT = 0x00000400;
	public final int GL_FRONT_RIGHT = 0x00000401;
	public final int GL_BACK_LEFT = 0x00000402;
	public final int GL_BACK_RIGHT = 0x00000403;
	public final int GL_AUX0 = 0x00000409;
	public final int GL_AUX1 = 0x0000040A;
	public final int GL_AUX2 = 0x0000040B;
	public final int GL_AUX3 = 0x0000040C;
	public final int GL_COLOR_INDEX = 0x00001900;
	public final int GL_RED = 0x00001903;
	public final int GL_GREEN = 0x00001904;
	public final int GL_BLUE = 0x00001905;
	public final int GL_ALPHA = 0x00001906;
	public final int GL_LUMINANCE = 0x00001909;
	public final int GL_LUMINANCE_ALPHA = 0x0000190A;
	public final int GL_ALPHA_BITS = 0x00000D55;
	public final int GL_RED_BITS = 0x00000D52;
	public final int GL_GREEN_BITS = 0x00000D53;
	public final int GL_BLUE_BITS = 0x00000D54;
	public final int GL_INDEX_BITS = 0x00000D51;
	public final int GL_SUBPIXEL_BITS = 0x00000D50;
	public final int GL_AUX_BUFFERS = 0x00000C00;
	public final int GL_READ_BUFFER = 0x00000C02;
	public final int GL_DRAW_BUFFER = 0x00000C01;
	public final int GL_DOUBLEBUFFER = 0x00000C32;
	public final int GL_STEREO = 0x00000C33;
	public final int GL_BITMAP = 0x00001A00;
	public final int GL_COLOR = 0x00001800;
	public final int GL_DEPTH = 0x00001801;
	public final int GL_STENCIL = 0x00001802;
	public final int GL_DITHER = 0x00000BD0;
	public final int GL_RGB = 0x00001907;
	public final int GL_RGBA = 0x00001908;

	/* Implementation limits */
	public final int GL_MAX_LIST_NESTING = 0x00000B31;
	public final int GL_MAX_EVAL_ORDER = 0x00000D30;
	public final int GL_MAX_LIGHTS = 0x00000D31;
	public final int GL_MAX_CLIP_PLANES = 0x00000D32;
	public final int GL_MAX_TEXTURE_SIZE = 0x00000D33;
	public final int GL_MAX_PIXEL_MAP_TABLE = 0x00000D34;
	public final int GL_MAX_ATTRIB_STACK_DEPTH = 0x00000D35;
	public final int GL_MAX_MODELVIEW_STACK_DEPTH = 0x00000D36;
	public final int GL_MAX_NAME_STACK_DEPTH = 0x00000D37;
	public final int GL_MAX_PROJECTION_STACK_DEPTH = 0x00000D38;
	public final int GL_MAX_TEXTURE_STACK_DEPTH = 0x00000D39;
	public final int GL_MAX_VIEWPORT_DIMS = 0x00000D3A;
	public final int GL_MAX_CLIENT_ATTRIB_STACK_DEPTH = 0x00000D3B;

	/* Gets */
	public final int GL_ATTRIB_STACK_DEPTH = 0x00000BB0;
	public final int GL_CLIENT_ATTRIB_STACK_DEPTH = 0x00000BB1;
	public final int GL_COLOR_CLEAR_VALUE = 0x00000C22;
	public final int GL_COLOR_WRITEMASK = 0x00000C23;
	public final int GL_CURRENT_INDEX = 0x00000B01;
	public final int GL_CURRENT_COLOR = 0x00000B00;
	public final int GL_CURRENT_NORMAL = 0x00000B02;
	public final int GL_CURRENT_RASTER_COLOR = 0x00000B04;
	public final int GL_CURRENT_RASTER_DISTANCE = 0x00000B09;
	public final int GL_CURRENT_RASTER_INDEX = 0x00000B05;
	public final int GL_CURRENT_RASTER_POSITION = 0x00000B07;
	public final int GL_CURRENT_RASTER_TEXTURE_COORDS = 0x00000B06;
	public final int GL_CURRENT_RASTER_POSITION_VALID = 0x00000B08;
	public final int GL_CURRENT_TEXTURE_COORDS = 0x00000B03;
	public final int GL_INDEX_CLEAR_VALUE = 0x00000C20;
	public final int GL_INDEX_MODE = 0x00000C30;
	public final int GL_INDEX_WRITEMASK = 0x00000C21;
	public final int GL_MODELVIEW_MATRIX = 0x00000BA6;
	public final int GL_MODELVIEW_STACK_DEPTH = 0x00000BA3;
	public final int GL_NAME_STACK_DEPTH = 0x00000D70;
	public final int GL_PROJECTION_MATRIX = 0x00000BA7;
	public final int GL_PROJECTION_STACK_DEPTH = 0x00000BA4;
	public final int GL_RENDER_MODE = 0x00000C40;
	public final int GL_RGBA_MODE = 0x00000C31;
	public final int GL_TEXTURE_MATRIX = 0x00000BA8;
	public final int GL_TEXTURE_STACK_DEPTH = 0x00000BA5;
	public final int GL_VIEWPORT = 0x00000BA2;

	/* Evaluators */
	public final int GL_AUTO_NORMAL = 0x00000D80;
	public final int GL_MAP1_COLOR_4 = 0x00000D90;
	public final int GL_MAP1_INDEX = 0x00000D91;
	public final int GL_MAP1_NORMAL = 0x00000D92;
	public final int GL_MAP1_TEXTURE_COORD_1 = 0x00000D93;
	public final int GL_MAP1_TEXTURE_COORD_2 = 0x00000D94;
	public final int GL_MAP1_TEXTURE_COORD_3 = 0x00000D95;
	public final int GL_MAP1_TEXTURE_COORD_4 = 0x00000D96;
	public final int GL_MAP1_VERTEX_3 = 0x00000D97;
	public final int GL_MAP1_VERTEX_4 = 0x00000D98;
	public final int GL_MAP2_COLOR_4 = 0x00000DB0;
	public final int GL_MAP2_INDEX = 0x00000DB1;
	public final int GL_MAP2_NORMAL = 0x00000DB2;
	public final int GL_MAP2_TEXTURE_COORD_1 = 0x00000DB3;
	public final int GL_MAP2_TEXTURE_COORD_2 = 0x00000DB4;
	public final int GL_MAP2_TEXTURE_COORD_3 = 0x00000DB5;
	public final int GL_MAP2_TEXTURE_COORD_4 = 0x00000DB6;
	public final int GL_MAP2_VERTEX_3 = 0x00000DB7;
	public final int GL_MAP2_VERTEX_4 = 0x00000DB8;
	public final int GL_MAP1_GRID_DOMAIN = 0x00000DD0;
	public final int GL_MAP1_GRID_SEGMENTS = 0x00000DD1;
	public final int GL_MAP2_GRID_DOMAIN = 0x00000DD2;
	public final int GL_MAP2_GRID_SEGMENTS = 0x00000DD3;
	public final int GL_COEFF = 0x00000A00;
	public final int GL_ORDER = 0x00000A01;
	public final int GL_DOMAIN = 0x00000A02;

	/* Hints */
	public final int GL_PERSPECTIVE_CORRECTION_HINT = 0x00000C50;
	public final int GL_POINT_SMOOTH_HINT = 0x00000C51;
	public final int GL_LINE_SMOOTH_HINT = 0x00000C52;
	public final int GL_POLYGON_SMOOTH_HINT = 0x00000C53;
	public final int GL_FOG_HINT = 0x00000C54;
	public final int GL_DONT_CARE = 0x00001100;
	public final int GL_FASTEST = 0x00001101;
	public final int GL_NICEST = 0x00001102;

	/* Scissor box */
	public final int GL_SCISSOR_BOX = 0x00000C10;
	public final int GL_SCISSOR_TEST = 0x00000C11;

	/* Pixel Mode / Transfer */
	public final int GL_MAP_COLOR = 0x00000D10;
	public final int GL_MAP_STENCIL = 0x00000D11;
	public final int GL_INDEX_SHIFT = 0x00000D12;
	public final int GL_INDEX_OFFSET = 0x00000D13;
	public final int GL_RED_SCALE = 0x00000D14;
	public final int GL_RED_BIAS = 0x00000D15;
	public final int GL_GREEN_SCALE = 0x00000D18;
	public final int GL_GREEN_BIAS = 0x00000D19;
	public final int GL_BLUE_SCALE = 0x00000D1A;
	public final int GL_BLUE_BIAS = 0x00000D1B;
	public final int GL_ALPHA_SCALE = 0x00000D1C;
	public final int GL_ALPHA_BIAS = 0x00000D1D;
	public final int GL_DEPTH_SCALE = 0x00000D1E;
	public final int GL_DEPTH_BIAS = 0x00000D1F;
	public final int GL_PIXEL_MAP_S_TO_S_SIZE = 0x00000CB1;
	public final int GL_PIXEL_MAP_I_TO_I_SIZE = 0x00000CB0;
	public final int GL_PIXEL_MAP_I_TO_R_SIZE = 0x00000CB2;
	public final int GL_PIXEL_MAP_I_TO_G_SIZE = 0x00000CB3;
	public final int GL_PIXEL_MAP_I_TO_B_SIZE = 0x00000CB4;
	public final int GL_PIXEL_MAP_I_TO_A_SIZE = 0x00000CB5;
	public final int GL_PIXEL_MAP_R_TO_R_SIZE = 0x00000CB6;
	public final int GL_PIXEL_MAP_G_TO_G_SIZE = 0x00000CB7;
	public final int GL_PIXEL_MAP_B_TO_B_SIZE = 0x00000CB8;
	public final int GL_PIXEL_MAP_A_TO_A_SIZE = 0x00000CB9;
	public final int GL_PIXEL_MAP_S_TO_S = 0x00000C71;
	public final int GL_PIXEL_MAP_I_TO_I = 0x00000C70;
	public final int GL_PIXEL_MAP_I_TO_R = 0x00000C72;
	public final int GL_PIXEL_MAP_I_TO_G = 0x00000C73;
	public final int GL_PIXEL_MAP_I_TO_B = 0x00000C74;
	public final int GL_PIXEL_MAP_I_TO_A = 0x00000C75;
	public final int GL_PIXEL_MAP_R_TO_R = 0x00000C76;
	public final int GL_PIXEL_MAP_G_TO_G = 0x00000C77;
	public final int GL_PIXEL_MAP_B_TO_B = 0x00000C78;
	public final int GL_PIXEL_MAP_A_TO_A = 0x00000C79;
	public final int GL_PACK_ALIGNMENT = 0x00000D05;
	public final int GL_PACK_LSB_FIRST = 0x00000D01;
	public final int GL_PACK_ROW_LENGTH = 0x00000D02;
	public final int GL_PACK_SKIP_PIXELS = 0x00000D04;
	public final int GL_PACK_SKIP_ROWS = 0x00000D03;
	public final int GL_PACK_SWAP_BYTES = 0x00000D00;
	public final int GL_UNPACK_ALIGNMENT = 0x00000CF5;
	public final int GL_UNPACK_LSB_FIRST = 0x00000CF1;
	public final int GL_UNPACK_ROW_LENGTH = 0x00000CF2;
	public final int GL_UNPACK_SKIP_PIXELS = 0x00000CF4;
	public final int GL_UNPACK_SKIP_ROWS = 0x00000CF3;
	public final int GL_UNPACK_SWAP_BYTES = 0x00000CF0;
	public final int GL_ZOOM_X = 0x00000D16;
	public final int GL_ZOOM_Y = 0x00000D17;

	/* Texture mapping */
	public final int GL_TEXTURE_ENV = 0x00002300;
	public final int GL_TEXTURE_ENV_MODE = 0x00002200;
	public final int GL_TEXTURE_1D = 0x00000DE0;
	public final int GL_TEXTURE_2D = 0x00000DE1;
	public final int GL_TEXTURE_WRAP_S = 0x00002802;
	public final int GL_TEXTURE_WRAP_T = 0x00002803;
	public final int GL_TEXTURE_MAG_FILTER = 0x00002800;
	public final int GL_TEXTURE_MIN_FILTER = 0x00002801;
	public final int GL_TEXTURE_ENV_COLOR = 0x00002201;
	public final int GL_TEXTURE_GEN_S = 0x00000C60;
	public final int GL_TEXTURE_GEN_T = 0x00000C61;
	public final int GL_TEXTURE_GEN_R = 0x00000C62;
	public final int GL_TEXTURE_GEN_Q = 0x00000C63;
	public final int GL_TEXTURE_GEN_MODE = 0x00002500;
	public final int GL_TEXTURE_BORDER_COLOR = 0x00001004;
	public final int GL_TEXTURE_WIDTH = 0x00001000;
	public final int GL_TEXTURE_HEIGHT = 0x00001001;
	public final int GL_TEXTURE_BORDER = 0x00001005;
	public final int GL_TEXTURE_COMPONENTS = 0x00001003;
	public final int GL_TEXTURE_RED_SIZE = 0x0000805C;
	public final int GL_TEXTURE_GREEN_SIZE = 0x0000805D;
	public final int GL_TEXTURE_BLUE_SIZE = 0x0000805E;
	public final int GL_TEXTURE_ALPHA_SIZE = 0x0000805F;
	public final int GL_TEXTURE_LUMINANCE_SIZE = 0x00008060;
	public final int GL_TEXTURE_INTENSITY_SIZE = 0x00008061;
	public final int GL_NEAREST_MIPMAP_NEAREST = 0x00002700;
	public final int GL_NEAREST_MIPMAP_LINEAR = 0x00002702;
	public final int GL_LINEAR_MIPMAP_NEAREST = 0x00002701;
	public final int GL_LINEAR_MIPMAP_LINEAR = 0x00002703;
	public final int GL_OBJECT_LINEAR = 0x00002401;
	public final int GL_OBJECT_PLANE = 0x00002501;
	public final int GL_EYE_LINEAR = 0x00002400;
	public final int GL_EYE_PLANE = 0x00002502;
	public final int GL_SPHERE_MAP = 0x00002402;
	public final int GL_DECAL = 0x00002101;
	public final int GL_MODULATE = 0x00002100;
	public final int GL_NEAREST = 0x00002600;
	public final int GL_REPEAT = 0x00002901;
	public final int GL_CLAMP = 0x00002900;
	public final int GL_S = 0x00002000;
	public final int GL_T = 0x00002001;
	public final int GL_R = 0x00002002;
	public final int GL_Q = 0x00002003;

	/* Utility */
	public final int GL_VENDOR = 0x00001F00;
	public final int GL_RENDERER = 0x00001F01;
	public final int GL_VERSION = 0x00001F02;
	public final int GL_EXTENSIONS = 0x00001F03;

	/* Errors */
	public final int GL_NO_ERROR = 0;
	public final int GL_INVALID_ENUM = 0x00000500;
	public final int GL_INVALID_VALUE = 0x00000501;
	public final int GL_INVALID_OPERATION = 0x00000502;
	public final int GL_STACK_OVERFLOW = 0x00000503;
	public final int GL_STACK_UNDERFLOW = 0x00000504;
	public final int GL_OUT_OF_MEMORY = 0x00000505;

	/* glPush/PopAttrib bits */
	public final int GL_CURRENT_BIT = 0x00000001;
	public final int GL_POINT_BIT = 0x00000002;
	public final int GL_LINE_BIT = 0x00000004;
	public final int GL_POLYGON_BIT = 0x00000008;
	public final int GL_POLYGON_STIPPLE_BIT = 0x00000010;
	public final int GL_PIXEL_MODE_BIT = 0x00000020;
	public final int GL_LIGHTING_BIT = 0x00000040;
	public final int GL_FOG_BIT = 0x00000080;
	public final int GL_DEPTH_BUFFER_BIT = 0x00000100;
	public final int GL_ACCUM_BUFFER_BIT = 0x00000200;
	public final int GL_STENCIL_BUFFER_BIT = 0x00000400;
	public final int GL_VIEWPORT_BIT = 0x00000800;
	public final int GL_TRANSFORM_BIT = 0x00001000;
	public final int GL_ENABLE_BIT = 0x00002000;
	public final int GL_COLOR_BUFFER_BIT = 0x00004000;
	public final int GL_HINT_BIT = 0x00008000;
	public final int GL_EVAL_BIT = 0x00010000;
	public final int GL_LIST_BIT = 0x00020000;
	public final int GL_TEXTURE_BIT = 0x00040000;
	public final int GL_SCISSOR_BIT = 0x00080000;
	public final int GL_ALL_ATTRIB_BITS = 0xFFFFFFFF;

	/* OpenGL 1.1 */
	public final int GL_PROXY_TEXTURE_1D = 0x00008063;
	public final int GL_PROXY_TEXTURE_2D = 0x00008064;
	public final int GL_TEXTURE_PRIORITY = 0x00008066;
	public final int GL_TEXTURE_RESIDENT = 0x00008067;
	public final int GL_TEXTURE_BINDING_1D = 0x00008068;
	public final int GL_TEXTURE_BINDING_2D = 0x00008069;
	public final int GL_TEXTURE_INTERNAL_FORMAT = 0x00001003;
	public final int GL_ALPHA4 = 0x0000803B;
	public final int GL_ALPHA8 = 0x0000803C;
	public final int GL_ALPHA12 = 0x0000803D;
	public final int GL_ALPHA16 = 0x0000803E;
	public final int GL_LUMINANCE4 = 0x0000803F;
	public final int GL_LUMINANCE8 = 0x00008040;
	public final int GL_LUMINANCE12 = 0x00008041;
	public final int GL_LUMINANCE16 = 0x00008042;
	public final int GL_LUMINANCE4_ALPHA4 = 0x00008043;
	public final int GL_LUMINANCE6_ALPHA2 = 0x00008044;
	public final int GL_LUMINANCE8_ALPHA8 = 0x00008045;
	public final int GL_LUMINANCE12_ALPHA4 = 0x00008046;
	public final int GL_LUMINANCE12_ALPHA12 = 0x00008047;
	public final int GL_LUMINANCE16_ALPHA16 = 0x00008048;
	public final int GL_INTENSITY = 0x00008049;
	public final int GL_INTENSITY4 = 0x0000804A;
	public final int GL_INTENSITY8 = 0x0000804B;
	public final int GL_INTENSITY12 = 0x0000804C;
	public final int GL_INTENSITY16 = 0x0000804D;
	public final int GL_R3_G3_B2 = 0x00002A10;
	public final int GL_RGB4 = 0x0000804F;
	public final int GL_RGB5 = 0x00008050;
	public final int GL_RGB8 = 0x00008051;
	public final int GL_RGB10 = 0x00008052;
	public final int GL_RGB12 = 0x00008053;
	public final int GL_RGB16 = 0x00008054;
	public final int GL_RGBA2 = 0x00008055;
	public final int GL_RGBA4 = 0x00008056;
	public final int GL_RGB5_A1 = 0x00008057;
	public final int GL_RGBA8 = 0x00008058;
	public final int GL_RGB10_A2 = 0x00008059;
	public final int GL_RGBA12 = 0x0000805A;
	public final int GL_RGBA16 = 0x0000805B;
	public final int GL_CLIENT_PIXEL_STORE_BIT = 0x00000001;
	public final int GL_CLIENT_VERTEX_ARRAY_BIT = 0x00000002;
	public final int GL_ALL_CLIENT_ATTRIB_BITS = 0xFFFFFFFF;
	public final int GL_CLIENT_ALL_ATTRIB_BITS = 0xFFFFFFFF;
	/*
	 * Miscellaneous
	 */
	...
	public native void glClearIndex(double c);

	public native void glClearColor(double red, double green, double blue, double alpha);
	...
	public native void glColorMask(int red, int green, int blue, int alpha);

	public native void glAlphaFunc(int func, double ref);
	...
	public native void glPointSize(double size);

	public native void glLineWidth(double width);

	public native void glLineStipple(int factor, int pattern);

	public native void glPolygonMode(int face, int mode);

	public native void glPolygonOffset(double factor, double units);

	public native void glPolygonOffset(float factor, float units);

	public native void glPolygonStipple(final byte[] mask);

	public native void glPolygonStipple(final int[] mask);

	public native void glGetPolygonStipple(byte[] mask);

	public native byte[] glGetPolygonStipple();

	public native byte[] glGetPolygonStipple(byte byteDummy); // synonymous with glGetPolygonStipple(), but symmetrical with glGetPolygonStipple(int)

	public native void glGetPolygonStipple(int[] mask);

	public native int[] glGetPolygonStipple(int typeDummy); // int argument is to distinguish it from byte

	public native void glEdgeFlag(int flag);

	public native void glEdgeFlag(boolean flag);

	public native void glEdgeFlagv(final int[] flag);

	public native void glEdgeFlagv(final boolean[] flag);
	...
	public native double[] glGetClipPlane(int plane);
	...
	public native int glIsEnabled(int cap);

	public native void glEnableClientState(int cap); /* 1.1 */

	public native void glDisableClientState(int cap); /* 1.1 */
	...
	public native void glGetFloatv(int pname, double[] params);
	...
	public native void glPushClientAttrib(int mask); /* 1.1 */

	public native void glPopClientAttrib(); /* 1.1 */
	...
	public native void glDepthMask(int flag);

	public native void glDepthMask(boolean flag);

	public native void glDepthRange(double near_val, double far_val);

	/*
	 * Accumulation Buffer
	 */

	public native void glClearAccum(double red, double green, double blue, double alpha);
	...
	public native void glAccum(int op, double value);
	...
	public native void glOrtho(double left, double right, double bottom, double top, double near_val, double far_val);

	public native void glFrustum(double left, double right, double bottom, double top, double near_val, double far_val);
	...
	public native void glLoadMatrixd(final double[] m);

	public native void glLoadMatrixf(final float[] m);

	public native void glMultMatrixd(final double[] m);

	public native void glMultMatrixf(final float[] m);
	...
	public native void glRotatef(double angle, double x, double y, double z); // DPP: 190104T1430: C/C++ effectively allows this.

	public native void glScaled(double x, double y, double z);

	public native void glScalef(double x, double y, double z);

	public native void glTranslated(double x, double y, double z);

	public native void glTranslatef(double x, double y, double z);

	/*
	 * Display Lists
	 */

	public native int glIsList(int list);
	...
	public native void glCallLists(int n, int type, final byte[] lists);

	public native void glCallLists(int n, int type, final short[] lists);

	public native void glCallLists(int n, int type, final int[] lists);

	public native void glCallLists(int n, int type, final float[] lists);
	...
	public native void glVertex2f(double x, double y);

	public native void glVertex2i(int x, int y);

	public native void glVertex2s(int x, int y);
	...
	public native void glVertex3f(double x, double y, double z);

	public native void glVertex3i(int x, int y, int z);

	public native void glVertex3s(int x, int y, int z);

	public native void glVertex3s(short x, short y, short z);

	public native void glVertex4d(double x, double y, double z, double w);

	public native void glVertex4f(double x, double y, double z, double w);
	...
	public native void glVertex4s(int x, int y, int z, int w);

	public native void glVertex2dv(final double[] v);

	public native void glVertex2fv(final float[] v);

	public native void glVertex2iv(final int[] v);

	public native void glVertex2sv(final short[] v);

	public native void glVertex3dv(double[] v);

	public native void glVertex3fv(double[] v);

	public native void glVertex3fv(float[] v);

	public native void glVertex3iv(final int[] v);

	public native void glVertex3sv(final short[] v);

	public native void glVertex4dv(final double[] v);

	public native void glVertex4fv(final float[] v);

	public native void glVertex4fv(final double[] v);

	public native void glVertex4iv(final int[] v);

	public native void glVertex4sv(final short[] v);
	...
	public native void glNormal3f(double nx, double ny, double nz);

	public native void glNormal3i(int nx, int ny, int nz);

	public native void glNormal3s(short nx, short ny, short nz);

	public native void glNormal3bv(final byte[] v);

	public native void glNormal3dv(final double[] v);

	public native void glNormal3fv(final double[] v);

	public native void glNormal3fv(final float[] v);

	public native void glNormal3iv(final int[] v);

	public native void glNormal3sv(final short[] v);

	public native void glIndexd(double c);

	public native void glIndexf(float c);

	public native void glIndexf(double c);

	public native void glIndexi(int c);

	public native void glIndexs(short c);

	public native void glIndexub(byte c); /* 1.1 */

	public native void glIndexdv(final double[] c);

	public native void glIndexfv(final float[] c);

	public native void glIndexfv(final double[] c);

	public native void glIndexiv(final int[] c);

	public native void glIndexsv(final short[] c);

	public native void glIndexubv(final byte[] c); /* 1.1 */
	...
	public native void glColor3f(double red, double green, double blue); // DPP: 190104T144900: C/C++ effectively allows this.
	...
	public native void glColor4f(double red, double green, double blue, double alpha);
	...
	public native void glColor3bv(final byte[] v);

	public native void glColor3dv(final double[] v);

	public native void glColor3fv(final double[] v);

	public native void glColor3fv(final float[] v);

	public native void glColor3iv(final int[] v);

	public native void glColor3sv(final short[] v);

	public native void glColor3ubv(final byte[] v);

	public native void glColor3uiv(final int[] v);

	public native void glColor3usv(final short[] v);

	public native void glColor4bv(final byte[] v);

	public native void glColor4dv(final double[] v);

	public native void glColor4fv(final double[] v);

	public native void glColor4fv(final float[] v);

	public native void glColor4iv(final int[] v);

	public native void glColor4sv(final short[] v);

	public native void glColor4ubv(final byte[] v);

	public native void glColor4uiv(final int[] v);

	public native void glColor4usv(final short[] v);
	...
	public native void glTexCoord2f(double s, double t);
	...
	public native void glTexCoord3f(double s, double t, double r);
	...
	public native void glTexCoord4f(double s, double t, double r, double q);

	public native void glTexCoord4i(int s, int t, int r, int q);

	public native void glTexCoord4s(short s, short t, short r, short q);

	public native void glTexCoord1dv(final double[] v);

	public native void glTexCoord1fv(final float[] v);

	public native void glTexCoord1fv(final double[] v);

	public native void glTexCoord1iv(final int[] v);

	public native void glTexCoord1sv(final short[] v);

	public native void glTexCoord2dv(final double[] v);

	public native void glTexCoord2fv(final float[] v);

	public native void glTexCoord2fv(final double[] v);

	public native void glTexCoord2iv(final int[] v);

	public native void glTexCoord2sv(final short[] v);

	public native void glTexCoord3dv(final double[] v);

	public native void glTexCoord3fv(final float[] v);

	public native void glTexCoord3fv(final double[] v);

	public native void glTexCoord3iv(final int[] v);

	public native void glTexCoord3sv(final short[] v);

	public native void glTexCoord4dv(final double[] v);

	public native void glTexCoord4fv(final float[] v);

	public native void glTexCoord4fv(final double[] v);

	public native void glTexCoord4iv(final int[] v);

	public native void glTexCoord4sv(final short[] v);

	public native void glRasterPos2d(double x, double y);

	public native void glRasterPos2f(float x, float y);

	public native void glRasterPos2f(double x, double y);
	...
	public native void glRasterPos3f(double x, double y, double z);
	...
	public native void glRasterPos4f(double x, double y, double z, double w);

	public native void glRasterPos4i(int x, int y, int z, int w);

	public native void glRasterPos4s(short x, short y, short z, short w);

	public native void glRasterPos2dv(final double[] v);

	public native void glRasterPos2fv(final float[] v);

	public native void glRasterPos2fv(final double[] v);

	public native void glRasterPos2iv(final int[] v);

	public native void glRasterPos2sv(final short[] v);

	public native void glRasterPos3dv(final double[] v);

	public native void glRasterPos3fv(final float[] v);

	public native void glRasterPos3fv(final double[] v);

	public native void glRasterPos3iv(final int[] v);

	public native void glRasterPos3sv(final short[] v);

	public native void glRasterPos4dv(final double[] v);

	public native void glRasterPos4fv(final float[] v);

	public native void glRasterPos4fv(final double[] v);

	public native void glRasterPos4iv(final int[] v);

	public native void glRasterPos4sv(final short[] v);

	public native void glRectd(double x1, double y1, double x2, double y2);

	public native void glRectf(double x1, double y1, double x2, double y2);

	public native void glRecti(int x1, int y1, int x2, int y2);

	public native void glRects(int x1, int y1, int x2, int y2);

	public native void glRectdv(final double[] v1, final double[] v2);

	public native void glRectfv(final float[] v1, final float[] v2);

	public native void glRectfv(final double[] v1, final double[] v2);

	public native void glRectiv(final int[] v1, final int[] v2);

	public native void glRectsv(final short[] v1, final short[] v2);

	/*
	 * Vertex Arrays (1.1)
	 */

	public native void glVertexPointer(int size, int type, int stride, final short[] ptr);

	public native void glVertexPointer(int size, int type, int stride, final int[] ptr);

	public native void glVertexPointer(int size, int type, int stride, final float[] ptr);

	public native void glVertexPointer(int size, int type, int stride, final double[] ptr);

	// public native void glNormalPointer(int type, int stride, final short[] ptr);

	// public native void glNormalPointer(int type, int stride, final int[] ptr);

	// public native void glNormalPointer(int type, int stride, final float[] ptr);

	// public native void glNormalPointer(int type, int stride, final double[] ptr);

	public native void glColorPointer(int size, int type, int stride, final short[] ptr);

	public native void glColorPointer(int size, int type, int stride, final int[] ptr);

	public native void glColorPointer(int size, int type, int stride, final float[] ptr);

	public native void glColorPointer(int size, int type, int stride, final double[] ptr);

	// public native void glIndexPointer(int type, int stride, final short[] ptr);

	// public native void glIndexPointer(int type, int stride, final int[] ptr);

	// public native void glIndexPointer(int type, int stride, final float[] ptr);

	// public native void glIndexPointer(int type, int stride, final double[] ptr);

	// public native void glTexCoordPointer(int size, int type, int stride, final short[] ptr);

	// public native void glTexCoordPointer(int size, int type, int stride, final int[] ptr);

	// public native void glTexCoordPointer(int size, int type, int stride, final float[] ptr);

	// public native void glTexCoordPointer(int size, int type, int stride, final double[] ptr);

	// public native void glEdgeFlagPointer(int stride, final short[] ptr);

	// public native void glEdgeFlagPointer(int stride, final int[] ptr);

	// public native void glEdgeFlagPointer(int stride, final float[] ptr);

	// public native void glEdgeFlagPointer(int stride, final double[] ptr);

	// public native void glGetPointerv(int pname, short[][] params);
	// public native short[][] glGetPointerv(int pname);

	// public native void glGetPointerv(int pname, int[][] params);
	// public native int[][] glGetPointerv(int pname);

	// public native void glGetPointerv(int pname, float[][] params);
	// public native float[][] glGetPointerv(int pname);

	// public native void glGetPointerv(int pname, double[][] params);
	// public native double[][] glGetPointerv(int pname);

	public native void glArrayElement(int i);

	public native void glDrawArrays(int mode, int first, int count);

	public native void glDrawElements(int mode, int count, int type, final byte[] indices);

	public native void glDrawElements(int mode, int count, int type, final short[] indices);

	public native void glDrawElements(int mode, int count, int type, final int[] indices);

	public native void glInterleavedArrays(int format, int stride, final int[] pointer);

	public native void glInterleavedArrays(int format, int stride, final float[] pointer);

	public native void glInterleavedArrays(int format, int stride, final double[] pointer);
	...
	public native void glLightf(int light, int pname, double param);

	public native void glLighti(int light, int pname, int param);

	public native void glLightfv(int light, int pname, double[] params);

	public native void glLightfv(int light, int pname, float[] params);

	public native void glLightiv(int light, int pname, final int[] params);

	// public native void glGetLightfv(int light, int pname, float[] params);
	// public native float[] glGetLightfv(int light, int pname);

	// public native void glGetLightiv(int light, int pname, int[] params);
	// public native int[] glGetLightiv(int light, int pname);

	public native void glLightModelf(int pname, double param);

	public native void glLightModelf(int pname, float param);

	public native void glLightModeli(int pname, int param);

	public native void glLightModeldv(int pname, final double[] params);

	public native void glLightModelfv(int pname, final double[] params);

	public native void glLightModelfv(int pname, final float[] params);

	public native void glLightModeliv(int pname, final int[] params);

	public native void glMaterialf(int face, int pname, double param);

	public native void glMaterialf(int face, int pname, float param);

	public native void glMateriali(int face, int pname, int param);

	public native void glMaterialfv(int face, int pname, double[] params);

	public native void glMaterialfv(int face, int pname, float[] params);

	public native void glMaterialiv(int face, int pname, final int[] params);

	// public native void glGetMaterialfv(int face, int pname, float[] params);
	// public native float[] glGetMaterialfv(int face, int pname);

	// public native void glGetMaterialiv(int face, int pname, int[] params);
	// public native int[] glGetMaterialiv(int face, int pname);
	...
	public native void glPixelZoom(double xfactor, double yfactor);

	public native void glPixelStoref(int pname, float param);

	public native void glPixelStoref(int pname, double param);

	public native void glPixelStorei(int pname, int param);

	public native void glPixelTransferf(int pname, float param);

	public native void glPixelTransferf(int pname, double param);

	public native void glPixelTransferi(int pname, int param);

	// public native void glPixelMapfv(int map, int mapsize, final float[] values);
	// public native void glPixelMapfv(int map, int mapsize, final double[] values);

	// public native void glPixelMapuiv(int map, int mapsize, final int[] values);

	// public native void glPixelMapusv(int map, int mapsize, final short[] values);

	// public native void glGetPixelMapfv(int map, float[] values);
	// public native float[] glGetPixelMapfv(int map);

	// public native void glGetPixelMapuiv(int map, int[] values);
	// public native int[] glGetPixelMapuiv(int map);

	// public native short[] glGetPixelMapusv(int map);
	// public native void glGetPixelMapusv(int map, short[] values);

	public native void glBitmap(int width, int height, double xorig, double yorig, double xmove, double ymove, final byte[] bitmap);

	public native void glBitmap(int width, int height, double xorig, double yorig, double xmove, double ymove, final short[] bitmap);

	public native void glBitmap(int width, int height, float xorig, float yorig, float xmove, float ymove, final byte[] bitmap);

	public native void glBitmap(int width, int height, float xorig, float yorig, float xmove, float ymove, final short[] bitmap);

	public native void glReadPixels(int x, int y, int width, int height, int format, int type, byte[] pixels);
	// public native byte[] glReadPixels(int x, int y, int width, int height, int format, int type);

	// public native void glReadPixels(int x, int y, int width, int height, int format, int type, short[] pixels);

	// public native void glReadPixels(int x, int y, int width, int height, int format, int type, int[] pixels);

	// public native void glReadPixels(int x, int y, int width, int height, int format, int type, float[] pixels);

	public native void glDrawPixels(int width, int height, int format, int type, final byte[] pixels);
//	public native void glDrawPixels(int width, int height, int format, int type, final byte[][] pixels);
//	public native void glDrawPixels(int width, int height, int format, int type, final byte[][][] pixels);
//	public native void glDrawPixels(int width, int height, int format, int type, final byte[][][][] pixels);

//	public native void glDrawPixels(int width, int height, int format, int type, final short[] pixels);
//	public native void glDrawPixels(int width, int height, int format, int type, final short[][] pixels);
//	public native void glDrawPixels(int width, int height, int format, int type, final short[][][] pixels);
//	public native void glDrawPixels(int width, int height, int format, int type, final short[][][][] pixels);
//
//	public native void glDrawPixels(int width, int height, int format, int type, final int[] pixels);
//	public native void glDrawPixels(int width, int height, int format, int type, final int[][] pixels);
//	public native void glDrawPixels(int width, int height, int format, int type, final int[][][] pixels);
//	public native void glDrawPixels(int width, int height, int format, int type, final int[][][][] pixels);
//
//	public native void glDrawPixels(int width, int height, int format, int type, final float[] pixels);
//	public native void glDrawPixels(int width, int height, int format, int type, final float[][] pixels);
//	public native void glDrawPixels(int width, int height, int format, int type, final float[][][] pixels);
//	public native void glDrawPixels(int width, int height, int format, int type, final float[][][][] pixels);
	...
	public native void glTexGendv(int coord, int pname, final double[] params);

	public native void glTexGenfv(int coord, int pname, final float[] params);

	public native void glTexGenfv(int coord, int pname, final double[] params);

	public native void glTexGeniv(int coord, int pname, final int[] params);

	public native void glTexGeniv(int coord, int pname, final short[] params);
	...
	public native void glTexEnvf(int target, int pname, double param);

	public native void glTexEnvf(int target, int pname, float param);

	public native void glTexEnvi(int target, int pname, int param);

	// public native void glTexEnvfv(int target, int pname, final float[] params);

	// public native void glTexEnviv(int target, int pname, final int[] params);
	...
	public native void glTexParameterf(int target, int pname, double param);

	public native void glTexParameteri(int target, int pname, int param);

	// public native void glTexParameterfv(int target, int pname, final float[] params);

	// public native void glTexParameteriv(int target, int pname, final int[] params);
	...
	public native void glTexImage1D(int target, int level, int internalFormat, int width, int border, int format, int type, final byte[] pixels);
//	public native void glTexImage1D(int target, int level, int internalFormat, int width, int border, int format, int type, final byte[][] pixels);
//	public native void glTexImage1D(int target, int level, int internalFormat, int width, int border, int format, int type, final byte[][][] pixels);
//	public native void glTexImage1D(int target, int level, int internalFormat, int width, int border, int format, int type, final byte[][][][] pixels);

	public native void glTexImage1D(int target, int level, int internalFormat, int width, int border, int format, int type, final short[] pixels);
//	public native void glTexImage1D(int target, int level, int internalFormat, int width, int border, int format, int type, final short[][] pixels);
//	public native void glTexImage1D(int target, int level, int internalFormat, int width, int border, int format, int type, final short[][][] pixels);
//	public native void glTexImage1D(int target, int level, int internalFormat, int width, int border, int format, int type, final short[][][][] pixels);

	public native void glTexImage1D(int target, int level, int internalFormat, int width, int border, int format, int type, final int[] pixels);
//	public native void glTexImage1D(int target, int level, int internalFormat, int width, int border, int format, int type, final int[][] pixels);
//	public native void glTexImage1D(int target, int level, int internalFormat, int width, int border, int format, int type, final int[][][] pixels);
//	public native void glTexImage1D(int target, int level, int internalFormat, int width, int border, int format, int type, final int[][][][] pixels);

	public native void glTexImage1D(int target, int level, int internalFormat, int width, int border, int format, int type, final float[] pixels);
//	public native void glTexImage1D(int target, int level, int internalFormat, int width, int border, int format, int type, final float[][] pixels);
//	public native void glTexImage1D(int target, int level, int internalFormat, int width, int border, int format, int type, final float[][][] pixels);
//	public native void glTexImage1D(int target, int level, int internalFormat, int width, int border, int format, int type, final float[][][][] pixels);

	public native void glTexImage2D(int target, int level, int internalFormat, int width, int height, int border, int format, int type, final byte[] pixels);
	// public native void glTexImage2D(int target, int level, int internalFormat, int width, int height, int border, int format, int type, final byte[][] pixels);
	// public native void glTexImage2D(int target, int level, int internalFormat, int width, int height, int border, int format, int type, final byte[][][] pixels);
	// public native void glTexImage2D(int target, int level, int internalFormat, int width, int height, int border, int format, int type, final byte[][][][] pixels);

	public native void glTexImage2D(int target, int level, int internalFormat, int width, int height, int border, int format, int type, final short[] pixels);
	// public native void glTexImage2D(int target, int level, int internalFormat, int width, int height, int border, int format, int type, final short[][] pixels);
	// public native void glTexImage2D(int target, int level, int internalFormat, int width, int height, int border, int format, int type, final short[][][] pixels);
	// public native void glTexImage2D(int target, int level, int internalFormat, int width, int height, int border, int format, int type, final short[][][][] pixels);
	...
	// public native void glGetTexImage(int target, int level, int format, int type, short[] pixels);

	// public native void glGetTexImage(int target, int level, int format, int type, int[] pixels);

	// public native void glGetTexImage(int target, int level, int format, int type, float[] pixels);

	/* 1.1 functions */

	public native void glGenTextures(int n, int[] textures);

	public native int[] glGenTextures(int n);

	// public native void glDeleteTextures(int n, final int[] textures);

	public native void glBindTexture(int target, int texture);

	// public native void glPrioritizeTextures(int n, final int[] textures, final float[] priorities);

	// public native int glAreTexturesResident(int n, final int[] textures, int[] residences);

	// public native int glIsTexture(int texture);

	// public native void glTexSubImage1D(int target, int level, int xoffset, int width, int format, int type, final byte[] pixels);

	// public native void glTexSubImage1D(int target, int level, int xoffset, int width, int format, int type, final short[] pixels);

	// public native void glTexSubImage1D(int target, int level, int xoffset, int width, int format, int type, final int[] pixels);

	// public native void glTexSubImage1D(int target, int level, int xoffset, int width, int format, int type, final float[] pixels);

	public native void glTexSubImage2D(int target, int level, int xoffset, int yoffset, int width, int height, int format, int type, final byte[] pixels);

	public native void glTexSubImage2D(int target, int level, int xoffset, int yoffset, int width, int height, int format, int type, final short[] pixels);

	// public native void glTexSubImage2D(int target, int level, int xoffset, int yoffset, int width, int height, int format, int type, final int[] pixels);

	// public native void glTexSubImage2D(int target, int level, int xoffset, int yoffset, int width, int height, int format, int type, final float[] pixels);
	 ...
	 * Evaluators
	 */
	public native void glMap1d(int target, double u1, double u2, int stride, int order, final double[][] points);

	public native void glMap1f(int target, double u1, double u2, int stride, int order, final double[][] points);

	public native void glMap2d(int target, double u1, double u2, int ustride, int uorder, double v1, double v2, int vstride, int vorder, final double[][][] points);

	public native void glMap2f(int target, double u1, double u2, int ustride, int uorder, double v1, double v2, int vstride, int vorder, final double[][][] points);

	// public native void glGetMapdv(int target, int query, double[] v);
	// public native double[] glGetMapdv(int target, int query);

	// public native void glGetMapfv(int target, int query, float[] v);
	// public native float[] glGetMapfv(int target, int query);

	// public native void glGetMapiv(int target, int query, int[] v);
	// public native int[] glGetMapiv(int target, int query);

	public native void glEvalCoord1d(double u);

	public native void glEvalCoord1f(double u);

	public native void glEvalCoord1dv(final double[] u);

	public native void glEvalCoord1fv(final double[] u);

	public native void glEvalCoord2d(double u, double v);

	public native void glEvalCoord2f(double u, double v);

	public native void glEvalCoord2dv(final double[] u);

	public native void glEvalCoord2fv(final double[] u);

	public native void glMapGrid1d(int un, double u1, double u2);

	public native void glMapGrid1f(int un, double u1, double u2);

	public native void glMapGrid2d(int un, double u1, double u2, int vn, double v1, double v2);

	public native void glMapGrid2f(int un, double u1, double u2, int vn, double v1, double v2);
	 ...
	 * Fog
	 */
	public native void glFogf(int pname, double param);

	public native void glFogf(int pname, float param);

	public native void glFogi(int pname, int param);

	public native void glFogfv(int pname, final double[] params);

	public native void glFogfv(int pname, final float[] params);

	public native void glFogiv(int pname, final int[] params);
	...
	// public native float[] void glFeedbackBuffer(int size, int type);

	// public native void glPassThrough(float token);

	// public native void glSelectBuffer(int size, int[] buffer);
	// public native int[] glSelectBuffer(int size);
...
//	 */
//
//	public final int GL_RESCALE_NORMAL = 0x0000803A;
...
//	public final int GL_TEXTURE_MIN_LOD = 0x0000813A;
//	public final int GL_TEXTURE_MAX_LOD = 0x0000813B;
//	public final int GL_TEXTURE_BASE_LEVEL = 0x0000813C;
//	public final int GL_TEXTURE_MAX_LEVEL = 0x0000813D;
//	public final int GL_SMOOTH_POINT_SIZE_RANGE = 0x00000B12;
//	public final int GL_SMOOTH_POINT_SIZE_GRANULARITY = 0x00000B13;
//	public final int GL_SMOOTH_LINE_WIDTH_RANGE = 0x00000B22;
//	public final int GL_SMOOTH_LINE_WIDTH_GRANULARITY = 0x00000B23;
//	public final int GL_ALIASED_POINT_SIZE_RANGE = 0x0000846D;
//	public final int GL_ALIASED_LINE_WIDTH_RANGE = 0x0000846E;
//	public final int GL_PACK_SKIP_IMAGES = 0x0000806B;
//	public final int GL_PACK_IMAGE_HEIGHT = 0x0000806C;
//	public final int GL_UNPACK_SKIP_IMAGES = 0x0000806D;
//	public final int GL_UNPACK_IMAGE_HEIGHT = 0x0000806E;
//	public final int GL_TEXTURE_3D = 0x0000806F;
//	public final int GL_PROXY_TEXTURE_3D = 0x00008070;
//	public final int GL_TEXTURE_DEPTH = 0x00008071;
//	public final int GL_TEXTURE_WRAP_R = 0x00008072;
//	public final int GL_MAX_3D_TEXTURE_SIZE = 0x00008073;
//	public final int GL_TEXTURE_BINDING_3D = 0x0000806A;
//
//	public native void glDrawRangeElements( int mode, int start, int end, int count, int type, final byte [] indices );
//	public native void glDrawRangeElements( int mode, int start, int end, int count, int type, final short [] indices );
//	public native void glDrawRangeElements( int mode, int start, int end, int count, int type, final int [] indices );
//
//	public native void glTexImage3D( int target, int level, int internalFormat, int width, int height, int depth, int border, int format, int type, final byte [] pixels );
//	public native void glTexImage3D( int target, int level, int internalFormat, int width, int height, int depth, int border, int format, int type, final short [] pixels );
//	public native void glTexImage3D( int target, int level, int internalFormat, int width, int height, int depth, int border, int format, int type, final int [] pixels );
//	public native void glTexImage3D( int target, int level, int internalFormat, int width, int height, int depth, int border, int format, int type, final float [] pixels );
//
//	public native void glTexSubImage3D( int target, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth, int format, int type, final byte [] pixels);
//	public native void glTexSubImage3D( int target, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth, int format, int type, final short [] pixels);
//	public native void glTexSubImage3D( int target, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth, int format, int type, final int [] pixels);
//	public native void glTexSubImage3D( int target, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth, int format, int type, final float [] pixels);
//
...
//
//	typedef void (APIENTRYP PFNGLDRAWRANGEELEMENTSPROC) (int mode, int start, int end, int count, int type, final byte [] indices);
//	typedef void (APIENTRYP PFNGLTEXIMAGE3DPROC) (int target, int level, int internalformat, int width, int height, int depth, int border, int format, int type, final GLvoid [] pixels);
//	typedef void (APIENTRYP PFNGLTEXSUBIMAGE3DPROC) (int target, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth, int format, int type, final GLvoid [] pixels);
//	typedef void (APIENTRYP PFNGLCOPYTEXSUBIMAGE3DPROC) (int target, int level, int xoffset, int yoffset, int zoffset, int x, int y, int width, int height);
//
//
//	/*
//	 * GL_ARB_imaging
//	 */
//
//	public final int GL_CONSTANT_COLOR = 0x00008001;
//	public final int GL_ONE_MINUS_CONSTANT_COLOR = 0x00008002;
//	public final int GL_CONSTANT_ALPHA = 0x00008003;
//	public final int GL_ONE_MINUS_CONSTANT_ALPHA = 0x00008004;
//	public final int GL_COLOR_TABLE = 0x000080D0;
//	public final int GL_POST_CONVOLUTION_COLOR_TABLE = 0x000080D1;
//	public final int GL_POST_COLOR_MATRIX_COLOR_TABLE = 0x000080D2;
//	public final int GL_PROXY_COLOR_TABLE = 0x000080D3;
//	public final int GL_PROXY_POST_CONVOLUTION_COLOR_TABLE = 0x000080D4;
//	public final int GL_PROXY_POST_COLOR_MATRIX_COLOR_TABLE = 0x000080D5;
//	public final int GL_COLOR_TABLE_SCALE = 0x000080D6;
//	public final int GL_COLOR_TABLE_BIAS = 0x000080D7;
//	public final int GL_COLOR_TABLE_FORMAT = 0x000080D8;
//	public final int GL_COLOR_TABLE_WIDTH = 0x000080D9;
//	public final int GL_COLOR_TABLE_RED_SIZE = 0x000080DA;
//	public final int GL_COLOR_TABLE_GREEN_SIZE = 0x000080DB;
//	public final int GL_COLOR_TABLE_BLUE_SIZE = 0x000080DC;
//	public final int GL_COLOR_TABLE_ALPHA_SIZE = 0x000080DD;
//	public final int GL_COLOR_TABLE_LUMINANCE_SIZE = 0x000080DE;
//	public final int GL_COLOR_TABLE_INTENSITY_SIZE = 0x000080DF;
//	public final int GL_CONVOLUTION_1D = 0x00008010;
//	public final int GL_CONVOLUTION_2D = 0x00008011;
//	public final int GL_SEPARABLE_2D = 0x00008012;
//	public final int GL_CONVOLUTION_BORDER_MODE = 0x00008013;
//	public final int GL_CONVOLUTION_FILTER_SCALE = 0x00008014;
//	public final int GL_CONVOLUTION_FILTER_BIAS = 0x00008015;
//	public final int GL_REDUCE = 0x00008016;
//	public final int GL_CONVOLUTION_FORMAT = 0x00008017;
//	public final int GL_CONVOLUTION_WIDTH = 0x00008018;
//	public final int GL_CONVOLUTION_HEIGHT = 0x00008019;
//	public final int GL_MAX_CONVOLUTION_WIDTH = 0x0000801A;
//	public final int GL_MAX_CONVOLUTION_HEIGHT = 0x0000801B;
//	public final int GL_POST_CONVOLUTION_RED_SCALE = 0x0000801C;
//	public final int GL_POST_CONVOLUTION_GREEN_SCALE = 0x0000801D;
//	public final int GL_POST_CONVOLUTION_BLUE_SCALE = 0x0000801E;
//	public final int GL_POST_CONVOLUTION_ALPHA_SCALE = 0x0000801F;
//	public final int GL_POST_CONVOLUTION_RED_BIAS = 0x00008020;
//	public final int GL_POST_CONVOLUTION_GREEN_BIAS = 0x00008021;
//	public final int GL_POST_CONVOLUTION_BLUE_BIAS = 0x00008022;
//	public final int GL_POST_CONVOLUTION_ALPHA_BIAS = 0x00008023;
//	public final int GL_CONSTANT_BORDER = 0x00008151;
//	public final int GL_REPLICATE_BORDER = 0x00008153;
//	public final int GL_CONVOLUTION_BORDER_COLOR = 0x00008154;
//	public final int GL_COLOR_MATRIX = 0x000080B1;
//	public final int GL_COLOR_MATRIX_STACK_DEPTH = 0x000080B2;
//	public final int GL_MAX_COLOR_MATRIX_STACK_DEPTH = 0x000080B3;
//	public final int GL_POST_COLOR_MATRIX_RED_SCALE = 0x000080B4;
//	public final int GL_POST_COLOR_MATRIX_GREEN_SCALE = 0x000080B5;
//	public final int GL_POST_COLOR_MATRIX_BLUE_SCALE = 0x000080B6;
//	public final int GL_POST_COLOR_MATRIX_ALPHA_SCALE = 0x000080B7;
//	public final int GL_POST_COLOR_MATRIX_RED_BIAS = 0x000080B8;
//	public final int GL_POST_COLOR_MATRIX_GREEN_BIAS = 0x000080B9;
//	public final int GL_POST_COLOR_MATRIX_BLUE_BIAS = 0x000080BA;
//	public final int GL_POST_COLOR_MATRIX_ALPHA_BIAS = 0x000080BB;
//	public final int GL_HISTOGRAM = 0x00008024;
//	public final int GL_PROXY_HISTOGRAM = 0x00008025;
//	public final int GL_HISTOGRAM_WIDTH = 0x00008026;
//	public final int GL_HISTOGRAM_FORMAT = 0x00008027;
//	public final int GL_HISTOGRAM_RED_SIZE = 0x00008028;
//	public final int GL_HISTOGRAM_GREEN_SIZE = 0x00008029;
//	public final int GL_HISTOGRAM_BLUE_SIZE = 0x0000802A;
//	public final int GL_HISTOGRAM_ALPHA_SIZE = 0x0000802B;
//	public final int GL_HISTOGRAM_LUMINANCE_SIZE = 0x0000802C;
//	public final int GL_HISTOGRAM_SINK = 0x0000802D;
//	public final int GL_MINMAX = 0x0000802E;
//	public final int GL_MINMAX_FORMAT = 0x0000802F;
//	public final int GL_MINMAX_SINK = 0x00008030;
//	public final int GL_TABLE_TOO_LARGE = 0x00008031;
//	public final int GL_BLEND_EQUATION = 0x00008009;
//	public final int GL_MIN = 0x00008007;
//	public final int GL_MAX = 0x00008008;
//	public final int GL_FUNC_ADD = 0x00008006;
//	public final int GL_FUNC_SUBTRACT = 0x0000800A;
//	public final int GL_FUNC_REVERSE_SUBTRACT = 0x0000800B;
//	public final int GL_BLEND_COLOR = 0x00008005;
//
//
//	public native void glColorTable( int target, int internalformat, int width, int format, int type, final byte [] table );
//	public native void glColorTable( int target, int internalformat, int width, int format, int type, final short [] table );
//	public native void glColorTable( int target, int internalformat, int width, int format, int type, final int [] table );
//
//	public native void glColorSubTable( int target, int start, int count, int format, int type, final byte [] data );
//	public native void glColorSubTable( int target, int start, int count, int format, int type, final short [] data );
//	public native void glColorSubTable( int target, int start, int count, int format, int type, final int [] data );
//
//	public native void glColorTableParameteriv(int target, int pname, final int [] params);
//
//	public native void glColorTableParameterfv(int target, int pname, final float [] params);
//
//	public native void glCopyColorSubTable( int target, int start, int x, int y, int width );
//
//	public native void glCopyColorTable( int target, int internalformat, int x, int y, int width );
//
//	public native void glGetColorTable( int target, int format, int type, byte [] table );
//	public native void glGetColorTable( int target, int format, int type, short [] table );
//	public native void glGetColorTable( int target, int format, int type, int [] table );
//
//	public native void glGetColorTableParameterfv( int target, int pname, float [] params );
//
//	public native void glGetColorTableParameteriv( int target, int pname, int [] params );
//
//	public native void glBlendEquation( int mode );
//
//	public native void glBlendColor( float red, float green, float blue, float alpha );
//
//	public native void glHistogram( int target, int width, int internalformat, int sink );
//
//	public native void glResetHistogram( int target );
//
//	public native void glGetHistogram( int target, int reset, int format, int type, byte [] values );
//	public native void glGetHistogram( int target, int reset, int format, int type, short [] values );
//	public native void glGetHistogram( int target, int reset, int format, int type, int [] values );
//
//	public native void glGetHistogramParameterfv( int target, int pname, float [] params );
//
//	public native void glGetHistogramParameteriv( int target, int pname, int [] params );
//
//	public native void glMinmax( int target, int internalformat, int sink );
//
//	public native void glResetMinmax( int target );
//
//	public native void glGetMinmax( int target, int reset, int format, int types, byte [] values );
//	public native void glGetMinmax( int target, int reset, int format, int types, short [] values );
//	public native void glGetMinmax( int target, int reset, int format, int types, int [] values );
//
//	public native void glGetMinmaxParameterfv( int target, int pname, float [] params );
//
//	public native void glGetMinmaxParameteriv( int target, int pname, int [] params );
//
//	public native void glConvolutionFilter1D( int target, int internalformat, int width, int format, int type, final byte [] image );
//	public native void glConvolutionFilter1D( int target, int internalformat, int width, int format, int type, final short [] image );
//	public native void glConvolutionFilter1D( int target, int internalformat, int width, int format, int type, final int [] image );
//
//	public native void glConvolutionFilter2D( int target, int internalformat, int width, int height, int format, int type, final byte [] image );
//	public native void glConvolutionFilter2D( int target, int internalformat, int width, int height, int format, int type, final short [] image );
//	public native void glConvolutionFilter2D( int target, int internalformat, int width, int height, int format, int type, final int [] image );
//
//	public native void glConvolutionParameterf( int target, int pname, float params );
//
//	public native void glConvolutionParameterfv( int target, int pname, final float [] params );
//
//	public native void glConvolutionParameteri( int target, int pname, int params );
//
//	public native void glConvolutionParameteriv( int target, int pname, final int [] params );
//
//	public native void glCopyConvolutionFilter1D( int target, int internalformat, int x, int y, int width );
//
//	public native void glCopyConvolutionFilter2D( int target,int internalformat, int x, int y, int width,int height);
//
//	public native void glGetConvolutionFilter( int target, int format,int type, byte [] image );
//	public native void glGetConvolutionFilter( int target, int format,int type, short [] image );
//	public native void glGetConvolutionFilter( int target, int format,int type, int [] image );
//
//	public native void glGetConvolutionParameterfv( int target, int pname,float [] params );
//
//	public native void glGetConvolutionParameteriv( int target, int pname,int [] params );
//
//	public native void glSeparableFilter2D( int target,int internalformat, int width, int height, int format,int type, final byte [] row, final byte [] column );
//	public native void glSeparableFilter2D( int target,int internalformat, int width, int height, int format,int type, final short [] row, final short [] column );
//	public native void glSeparableFilter2D( int target,int internalformat, int width, int height, int format,int type, final int [] row, final int [] column );
//
//	public native void glGetSeparableFilter( int target, int format,int type, byte [] row, byte [] column, byte [] span );
//	public native void glGetSeparableFilter( int target, int format,int type, short [] row, short [] column, short [] span );
//	public native void glGetSeparableFilter( int target, int format,int type, int [] row, int [] column, int [] span );
//
//
//
//
...
//
//	/* multitexture */
//	public final int GL_TEXTURE0 = 0x000084C0;
//	public final int GL_TEXTURE1 = 0x000084C1;
//	public final int GL_TEXTURE2 = 0x000084C2;
//	public final int GL_TEXTURE3 = 0x000084C3;
//	public final int GL_TEXTURE4 = 0x000084C4;
//	public final int GL_TEXTURE5 = 0x000084C5;
//	public final int GL_TEXTURE6 = 0x000084C6;
//	public final int GL_TEXTURE7 = 0x000084C7;
//	public final int GL_TEXTURE8 = 0x000084C8;
//	public final int GL_TEXTURE9 = 0x000084C9;
//	public final int GL_TEXTURE10 = 0x000084CA;
//	public final int GL_TEXTURE11 = 0x000084CB;
//	public final int GL_TEXTURE12 = 0x000084CC;
//	public final int GL_TEXTURE13 = 0x000084CD;
//	public final int GL_TEXTURE14 = 0x000084CE;
//	public final int GL_TEXTURE15 = 0x000084CF;
//	public final int GL_TEXTURE16 = 0x000084D0;
//	public final int GL_TEXTURE17 = 0x000084D1;
//	public final int GL_TEXTURE18 = 0x000084D2;
//	public final int GL_TEXTURE19 = 0x000084D3;
//	public final int GL_TEXTURE20 = 0x000084D4;
//	public final int GL_TEXTURE21 = 0x000084D5;
//	public final int GL_TEXTURE22 = 0x000084D6;
//	public final int GL_TEXTURE23 = 0x000084D7;
//	public final int GL_TEXTURE24 = 0x000084D8;
//	public final int GL_TEXTURE25 = 0x000084D9;
//	public final int GL_TEXTURE26 = 0x000084DA;
//	public final int GL_TEXTURE27 = 0x000084DB;
//	public final int GL_TEXTURE28 = 0x000084DC;
//	public final int GL_TEXTURE29 = 0x000084DD;
//	public final int GL_TEXTURE30 = 0x000084DE;
//	public final int GL_TEXTURE31 = 0x000084DF;
//	public final int GL_ACTIVE_TEXTURE = 0x000084E0;
//	public final int GL_CLIENT_ACTIVE_TEXTURE = 0x000084E1;
//	public final int GL_MAX_TEXTURE_UNITS = 0x000084E2;
//	/* texture_cube_map */
//	public final int GL_NORMAL_MAP = 0x00008511;
//	public final int GL_REFLECTION_MAP = 0x00008512;
//	public final int GL_TEXTURE_CUBE_MAP = 0x00008513;
//	public final int GL_TEXTURE_BINDING_CUBE_MAP = 0x00008514;
//	public final int GL_TEXTURE_CUBE_MAP_POSITIVE_X = 0x00008515;
//	public final int GL_TEXTURE_CUBE_MAP_NEGATIVE_X = 0x00008516;
//	public final int GL_TEXTURE_CUBE_MAP_POSITIVE_Y = 0x00008517;
//	public final int GL_TEXTURE_CUBE_MAP_NEGATIVE_Y = 0x00008518;
//	public final int GL_TEXTURE_CUBE_MAP_POSITIVE_Z = 0x00008519;
//	public final int GL_TEXTURE_CUBE_MAP_NEGATIVE_Z = 0x0000851A;
//	public final int GL_PROXY_TEXTURE_CUBE_MAP = 0x0000851B;
//	public final int GL_MAX_CUBE_MAP_TEXTURE_SIZE = 0x0000851C;
//	/* texture_compression */
//	public final int GL_COMPRESSED_ALPHA = 0x000084E9;
//	public final int GL_COMPRESSED_LUMINANCE = 0x000084EA;
//	public final int GL_COMPRESSED_LUMINANCE_ALPHA = 0x000084EB;
//	public final int GL_COMPRESSED_INTENSITY = 0x000084EC;
//	public final int GL_COMPRESSED_RGB = 0x000084ED;
//	public final int GL_COMPRESSED_RGBA = 0x000084EE;
//	public final int GL_TEXTURE_COMPRESSION_HINT = 0x000084EF;
//	public final int GL_TEXTURE_COMPRESSED_IMAGE_SIZE = 0x000086A0;
//	public final int GL_TEXTURE_COMPRESSED = 0x000086A1;
//	public final int GL_NUM_COMPRESSED_TEXTURE_FORMATS = 0x000086A2;
//	public final int GL_COMPRESSED_TEXTURE_FORMATS = 0x000086A3;
//	/* multisample */
//	public final int GL_MULTISAMPLE = 0x0000809D;
//	public final int GL_SAMPLE_ALPHA_TO_COVERAGE = 0x0000809E;
//	public final int GL_SAMPLE_ALPHA_TO_ONE = 0x0000809F;
//	public final int GL_SAMPLE_COVERAGE = 0x000080A0;
//	public final int GL_SAMPLE_BUFFERS = 0x000080A8;
//	public final int GL_SAMPLES = 0x000080A9;
//	public final int GL_SAMPLE_COVERAGE_VALUE = 0x000080AA;
//	public final int GL_SAMPLE_COVERAGE_INVERT = 0x000080AB;
//	public final int GL_MULTISAMPLE_BIT = 0x000020000000;
//	/* transpose_matrix */
//	public final int GL_TRANSPOSE_MODELVIEW_MATRIX = 0x000084E3;
//	public final int GL_TRANSPOSE_PROJECTION_MATRIX = 0x000084E4;
//	public final int GL_TRANSPOSE_TEXTURE_MATRIX = 0x000084E5;
//	public final int GL_TRANSPOSE_COLOR_MATRIX = 0x000084E6;
//	/* texture_env_combine */
//	public final int GL_COMBINE = 0x00008570;
//	public final int GL_COMBINE_RGB = 0x00008571;
//	public final int GL_COMBINE_ALPHA = 0x00008572;
//	public final int GL_SOURCE0_RGB = 0x00008580;
//	public final int GL_SOURCE1_RGB = 0x00008581;
//	public final int GL_SOURCE2_RGB = 0x00008582;
//	public final int GL_SOURCE0_ALPHA = 0x00008588;
//	public final int GL_SOURCE1_ALPHA = 0x00008589;
//	public final int GL_SOURCE2_ALPHA = 0x0000858A;
//	public final int GL_OPERAND0_RGB = 0x00008590;
//	public final int GL_OPERAND1_RGB = 0x00008591;
//	public final int GL_OPERAND2_RGB = 0x00008592;
//	public final int GL_OPERAND0_ALPHA = 0x00008598;
//	public final int GL_OPERAND1_ALPHA = 0x00008599;
//	public final int GL_OPERAND2_ALPHA = 0x0000859A;
//	public final int GL_RGB_SCALE = 0x00008573;
//	public final int GL_ADD_SIGNED = 0x00008574;
//	public final int GL_INTERPOLATE = 0x00008575;
//	public final int GL_SUBTRACT = 0x000084E7;
//	public final int GL_CONSTANT = 0x00008576;
//	public final int GL_PRIMARY_COLOR = 0x00008577;
//	public final int GL_PREVIOUS = 0x00008578;
//	/* texture_env_dot3 */
//	public final int GL_DOT3_RGB = 0x000086AE;
//	public final int GL_DOT3_RGBA = 0x000086AF;
//	/* texture_border_clamp */
//	public final int GL_CLAMP_TO_BORDER = 0x0000812D;
//
//	public native void glActiveTexture( int texture );
//
//	public native void glClientActiveTexture( int texture );
//
//	public native void glCompressedTexImage1D( int target, int level, int internalformat, int width, int border, int imageSize, final byte [] data );
//
//	public native void glCompressedTexImage2D( int target, int level, int internalformat, int width, int height, int border, int imageSize, final byte [] data );
//
//	public native void glCompressedTexImage3D( int target, int level, int internalformat, int width, int height, int depth, int border, int imageSize, final byte [] data );
//
//	public native void glCompressedTexSubImage1D( int target, int level, int xoffset, int width, int format, int imageSize, final byte [] data );
//
//	public native void glCompressedTexSubImage2D( int target, int level, int xoffset, int yoffset, int width, int height, int format, int imageSize, final byte [] data );
//
//	public native void glCompressedTexSubImage3D( int target, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth, int format, int imageSize, final byte [] data );
//
//	public native void glGetCompressedTexImage( int target, int lod, byte [] img );
//
//	public native void glMultiTexCoord1d( int target, double s );
//
//	public native void glMultiTexCoord1dv( int target, final double [] v );
//
//	public native void glMultiTexCoord1f( int target, float s );
//
//	public native void glMultiTexCoord1fv( int target, final float [] v );
//
//	public native void glMultiTexCoord1i( int target, int s );
//
//	public native void glMultiTexCoord1iv( int target, final int [] v );
//
//	public native void glMultiTexCoord1s( int target, short s );
//
//	public native void glMultiTexCoord1sv( int target, final short [] v );
//
//	public native void glMultiTexCoord2d( int target, double s, double t );
//
//	public native void glMultiTexCoord2dv( int target, final double [] v );
//
//	public native void glMultiTexCoord2f( int target, float s, float t );
//
//	public native void glMultiTexCoord2fv( int target, final float [] v );
//
//	public native void glMultiTexCoord2i( int target, int s, int t );
//
//	public native void glMultiTexCoord2iv( int target, final int [] v );
//
//	public native void glMultiTexCoord2s( int target, short s, short t );
//
//	public native void glMultiTexCoord2sv( int target, final short [] v );
//
//	public native void glMultiTexCoord3d( int target, double s, double t, double r );
//
//	public native void glMultiTexCoord3dv( int target, final double [] v );
//
//	public native void glMultiTexCoord3f( int target, float s, float t, float r );
//
//	public native void glMultiTexCoord3fv( int target, final float [] v );
//
//	public native void glMultiTexCoord3i( int target, int s, int t, int r );
//
//	public native void glMultiTexCoord3iv( int target, final int [] v );
//
//	public native void glMultiTexCoord3s( int target, short s, short t, short r );
//
//	public native void glMultiTexCoord3sv( int target, final short [] v );
//
//	public native void glMultiTexCoord4d( int target, double s, double t, double r, double q );
//
//	public native void glMultiTexCoord4dv( int target, final double [] v );
//
//	public native void glMultiTexCoord4f( int target, float s, float t, float r, float q );
//
//	public native void glMultiTexCoord4fv( int target, final float [] v );
//
//	public native void glMultiTexCoord4i( int target, int s, int t, int r, int q );
//
//	public native void glMultiTexCoord4iv( int target, final int [] v );
//
//	public native void glMultiTexCoord4s( int target, short s, short t, short r, short q );
//
//	public native void glMultiTexCoord4sv( int target, final short [] v );
//
//
//	public native void glLoadTransposeMatrixd( final double [] m );
//
//	public native void glLoadTransposeMatrixf( final float [] m );
//
//	public native void glMultTransposeMatrixd( final double [] m );
//
//	public native void glMultTransposeMatrixf( final float[] m );
//
//	public native void glSampleCoverage( float value, int invert );
//
//
//	typedef void (APIENTRYP PFNGLACTIVETEXTUREPROC) (int texture);
//	typedef void (APIENTRYP PFNGLSAMPLECOVERAGEPROC) (float value, int invert);
//	typedef void (APIENTRYP PFNGLCOMPRESSEDTEXIMAGE3DPROC) (int target, int level, int internalformat, int width, int height, int depth, int border, int imageSize, final GLvoid [] data);
//	typedef void (APIENTRYP PFNGLCOMPRESSEDTEXIMAGE2DPROC) (int target, int level, int internalformat, int width, int height, int border, int imageSize, final GLvoid [] data);
//	typedef void (APIENTRYP PFNGLCOMPRESSEDTEXIMAGE1DPROC) (int target, int level, int internalformat, int width, int border, int imageSize, final GLvoid [] data);
//	typedef void (APIENTRYP PFNGLCOMPRESSEDTEXSUBIMAGE3DPROC) (int target, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth, int format, int imageSize, final GLvoid [] data);
//	typedef void (APIENTRYP PFNGLCOMPRESSEDTEXSUBIMAGE2DPROC) (int target, int level, int xoffset, int yoffset, int width, int height, int format, int imageSize, final GLvoid [] data);
//	typedef void (APIENTRYP PFNGLCOMPRESSEDTEXSUBIMAGE1DPROC) (int target, int level, int xoffset, int width, int format, int imageSize, final GLvoid [] data);
//	typedef void (APIENTRYP PFNGLGETCOMPRESSEDTEXIMAGEPROC) (int target, int level, GLvoid [] img);
//
//
//
//	/*
...
//	 */
//	public final int GL_ARB_multitexture = 1;
//
//	public final int GL_TEXTURE0_ARB = 0x000084C0;
//	public final int GL_TEXTURE1_ARB = 0x000084C1;
//	public final int GL_TEXTURE2_ARB = 0x000084C2;
//	public final int GL_TEXTURE3_ARB = 0x000084C3;
//	public final int GL_TEXTURE4_ARB = 0x000084C4;
//	public final int GL_TEXTURE5_ARB = 0x000084C5;
//	public final int GL_TEXTURE6_ARB = 0x000084C6;
//	public final int GL_TEXTURE7_ARB = 0x000084C7;
//	public final int GL_TEXTURE8_ARB = 0x000084C8;
//	public final int GL_TEXTURE9_ARB = 0x000084C9;
//	public final int GL_TEXTURE10_ARB = 0x000084CA;
//	public final int GL_TEXTURE11_ARB = 0x000084CB;
//	public final int GL_TEXTURE12_ARB = 0x000084CC;
//	public final int GL_TEXTURE13_ARB = 0x000084CD;
//	public final int GL_TEXTURE14_ARB = 0x000084CE;
//	public final int GL_TEXTURE15_ARB = 0x000084CF;
//	public final int GL_TEXTURE16_ARB = 0x000084D0;
//	public final int GL_TEXTURE17_ARB = 0x000084D1;
//	public final int GL_TEXTURE18_ARB = 0x000084D2;
//	public final int GL_TEXTURE19_ARB = 0x000084D3;
//	public final int GL_TEXTURE20_ARB = 0x000084D4;
//	public final int GL_TEXTURE21_ARB = 0x000084D5;
//	public final int GL_TEXTURE22_ARB = 0x000084D6;
//	public final int GL_TEXTURE23_ARB = 0x000084D7;
//	public final int GL_TEXTURE24_ARB = 0x000084D8;
//	public final int GL_TEXTURE25_ARB = 0x000084D9;
//	public final int GL_TEXTURE26_ARB = 0x000084DA;
//	public final int GL_TEXTURE27_ARB = 0x000084DB;
//	public final int GL_TEXTURE28_ARB = 0x000084DC;
//	public final int GL_TEXTURE29_ARB = 0x000084DD;
//	public final int GL_TEXTURE30_ARB = 0x000084DE;
//	public final int GL_TEXTURE31_ARB = 0x000084DF;
//	public final int GL_ACTIVE_TEXTURE_ARB = 0x000084E0;
//	public final int GL_CLIENT_ACTIVE_TEXTURE_ARB = 0x000084E1;
//	public final int GL_MAX_TEXTURE_UNITS_ARB = 0x000084E2;
//
//	public native void glActiveTextureARB(int texture);
//	public native void glClientActiveTextureARB(int texture);
//	public native void glMultiTexCoord1dARB(int target, double s);
//	public native void glMultiTexCoord1dvARB(int target, final double [] v);
//	public native void glMultiTexCoord1fARB(int target, float s);
//	public native void glMultiTexCoord1fvARB(int target, final float [] v);
//	public native void glMultiTexCoord1iARB(int target, int s);
//	public native void glMultiTexCoord1ivARB(int target, final int [] v);
//	public native void glMultiTexCoord1sARB(int target, short s);
//	public native void glMultiTexCoord1svARB(int target, final short [] v);
//	public native void glMultiTexCoord2dARB(int target, double s, double t);
//	public native void glMultiTexCoord2dvARB(int target, final double [] v);
//	public native void glMultiTexCoord2fARB(int target, float s, float t);
//	public native void glMultiTexCoord2fvARB(int target, final float [] v);
//	public native void glMultiTexCoord2iARB(int target, int s, int t);
//	public native void glMultiTexCoord2ivARB(int target, final int [] v);
//	public native void glMultiTexCoord2sARB(int target, short s, short t);
//	public native void glMultiTexCoord2svARB(int target, final short [] v);
//	public native void glMultiTexCoord3dARB(int target, double s, double t, double r);
//	public native void glMultiTexCoord3dvARB(int target, final double [] v);
//	public native void glMultiTexCoord3fARB(int target, float s, float t, float r);
//	public native void glMultiTexCoord3fvARB(int target, final float [] v);
//	public native void glMultiTexCoord3iARB(int target, int s, int t, int r);
//	public native void glMultiTexCoord3ivARB(int target, final int [] v);
//	public native void glMultiTexCoord3sARB(int target, short s, short t, short r);
//	public native void glMultiTexCoord3svARB(int target, final short [] v);
//	public native void glMultiTexCoord4dARB(int target, double s, double t, double r, double q);
//	public native void glMultiTexCoord4dvARB(int target, final double [] v);
//	public native void glMultiTexCoord4fARB(int target, float s, float t, float r, float q);
//	public native void glMultiTexCoord4fvARB(int target, final float [] v);
//	public native void glMultiTexCoord4iARB(int target, int s, int t, int r, int q);
//	public native void glMultiTexCoord4ivARB(int target, final int [] v);
//	public native void glMultiTexCoord4sARB(int target, short s, short t, short r, short q);
//	public native void glMultiTexCoord4svARB(int target, final short [] v);

//	typedef void (APIENTRYP PFNGLACTIVETEXTUREARBPROC) (int texture);
//	typedef void (APIENTRYP PFNGLCLIENTACTIVETEXTUREARBPROC) (int texture);
//	typedef void (APIENTRYP PFNGLMULTITEXCOORD1DARBPROC) (int target, double s);
//	typedef void (APIENTRYP PFNGLMULTITEXCOORD1DVARBPROC) (int target, final double [] v);
//	typedef void (APIENTRYP PFNGLMULTITEXCOORD1FARBPROC) (int target, float s);
//	typedef void (APIENTRYP PFNGLMULTITEXCOORD1FVARBPROC) (int target, final float [] v);
//	typedef void (APIENTRYP PFNGLMULTITEXCOORD1IARBPROC) (int target, int s);
//	typedef void (APIENTRYP PFNGLMULTITEXCOORD1IVARBPROC) (int target, final int [] v);
//	typedef void (APIENTRYP PFNGLMULTITEXCOORD1SARBPROC) (int target, short s);
//	typedef void (APIENTRYP PFNGLMULTITEXCOORD1SVARBPROC) (int target, final short [] v);
//	typedef void (APIENTRYP PFNGLMULTITEXCOORD2DARBPROC) (int target, double s, double t);
//	typedef void (APIENTRYP PFNGLMULTITEXCOORD2DVARBPROC) (int target, final double [] v);
//	typedef void (APIENTRYP PFNGLMULTITEXCOORD2FARBPROC) (int target, float s, float t);
//	typedef void (APIENTRYP PFNGLMULTITEXCOORD2FVARBPROC) (int target, final float [] v);
//	typedef void (APIENTRYP PFNGLMULTITEXCOORD2IARBPROC) (int target, int s, int t);
//	typedef void (APIENTRYP PFNGLMULTITEXCOORD2IVARBPROC) (int target, final int [] v);
//	typedef void (APIENTRYP PFNGLMULTITEXCOORD2SARBPROC) (int target, short s, short t);
//	typedef void (APIENTRYP PFNGLMULTITEXCOORD2SVARBPROC) (int target, final short [] v);
//	typedef void (APIENTRYP PFNGLMULTITEXCOORD3DARBPROC) (int target, double s, double t, double r);
//	typedef void (APIENTRYP PFNGLMULTITEXCOORD3DVARBPROC) (int target, final double [] v);
//	typedef void (APIENTRYP PFNGLMULTITEXCOORD3FARBPROC) (int target, float s, float t, float r);
//	typedef void (APIENTRYP PFNGLMULTITEXCOORD3FVARBPROC) (int target, final float [] v);
//	typedef void (APIENTRYP PFNGLMULTITEXCOORD3IARBPROC) (int target, int s, int t, int r);
//	typedef void (APIENTRYP PFNGLMULTITEXCOORD3IVARBPROC) (int target, final int [] v);
//	typedef void (APIENTRYP PFNGLMULTITEXCOORD3SARBPROC) (int target, short s, short t, short r);
//	typedef void (APIENTRYP PFNGLMULTITEXCOORD3SVARBPROC) (int target, final short [] v);
//	typedef void (APIENTRYP PFNGLMULTITEXCOORD4DARBPROC) (int target, double s, double t, double r, double q);
//	typedef void (APIENTRYP PFNGLMULTITEXCOORD4DVARBPROC) (int target, final double [] v);
//	typedef void (APIENTRYP PFNGLMULTITEXCOORD4FARBPROC) (int target, float s, float t, float r, float q);
//	typedef void (APIENTRYP PFNGLMULTITEXCOORD4FVARBPROC) (int target, final float [] v);
//	typedef void (APIENTRYP PFNGLMULTITEXCOORD4IARBPROC) (int target, int s, int t, int r, int q);
//	typedef void (APIENTRYP PFNGLMULTITEXCOORD4IVARBPROC) (int target, final int [] v);
//	typedef void (APIENTRYP PFNGLMULTITEXCOORD4SARBPROC) (int target, short s, short t, short r, short q);
//	typedef void (APIENTRYP PFNGLMULTITEXCOORD4SVARBPROC) (int target, final short [] v);
...
//	#endif /* GL_WIN_specular_fog */
	...
	/*
	 * ???. GL_MESA_packed_depth_stencil XXX obsolete
	 */
//	#ifndef GL_MESA_packed_depth_stencil
//	#define GL_MESA_packed_depth_stencil 1
//
//	public final int GL_DEPTH_STENCIL_MESA = 0x00008750;
//	public final int GL_UNSIGNED_INT_24_8_MESA = 0x00008751;
//	public final int GL_UNSIGNED_INT_8_24_REV_MESA = 0x00008752;
//	public final int GL_UNSIGNED_SHORT_15_1_MESA = 0x00008753;
//	public final int GL_UNSIGNED_SHORT_1_15_REV_MESA = 0x00008754;
//
...
//
//	public final int GL_ALPHA_BLEND_EQUATION_ATI = 0x0000883D;
//
//	public native void glBlendEquationSeparateATI( int modeRGB, int modeA );
//	typedef void (APIENTRYP PFNGLBLENDEQUATIONSEPARATEATIPROC) (int modeRGB, int modeA);
//
...
//	#ifdef GL_GLEXT_PROTOTYPES
//	GLAPI void APIENTRY glEGLImageTargetTexture2DOES (int target, GLeglImageOES image);
//	GLAPI void APIENTRY glEGLImageTargetRenderbufferStorageOES (int target, GLeglImageOES image);
//	#endif
//	typedef void (APIENTRYP PFNGLEGLIMAGETARGETTEXTURE2DOESPROC) (int target, GLeglImageOES image);
//	typedef void (APIENTRYP PFNGLEGLIMAGETARGETRENDERBUFFERSTORAGEOESPROC) (int target, GLeglImageOES image);
//	#endif
//
//
//	/**
