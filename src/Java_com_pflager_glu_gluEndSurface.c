...
JNIEXPORT void JNICALL Java_com_pflager_glu_gluEndSurface(JNIEnv *env, jobject object, jobject nurbJObject) {
    DPRINTF("gluEndSurface(%p);\n", nurbJObject);
    ...
    gluEndSurface((GLUnurbs*)glunurbs);
}
