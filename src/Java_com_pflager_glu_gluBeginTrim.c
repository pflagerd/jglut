...
JNIEXPORT void JNICALL Java_com_pflager_glu_gluBeginTrim(JNIEnv *env, jobject object, jobject nurbJObject) {
    DPRINTF("gluBeginTrim(%p);\n", nurbJObject);
    ...
    gluBeginTrim((GLUnurbs*)glunurbs);
