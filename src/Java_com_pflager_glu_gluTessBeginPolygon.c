...
JNIEXPORT void JNICALL Java_com_pflager_glu_gluTessBeginPolygon(JNIEnv *env, jobject object, jobject tessJObject, jobject dataJObject) {
    DPRINTF("gluTessBeginPolygon(%p, %p);\n", tessJObject, dataJObject);
    ...
    gluTessBeginPolygon((GLUtesselator*)glutesselator, (GLvoid*)dataJObject);
}
