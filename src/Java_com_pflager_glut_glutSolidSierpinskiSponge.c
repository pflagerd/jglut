...
JNIEXPORT void JNICALL Java_com_pflager_glut_glutSolidSierpinskiSponge(JNIEnv *env, jobject object, jint num_levels, jdoubleArray offsetjDoubleArray, jdouble scale) {
    DPRINTF("glutSolidSierpinskiSponge(%d, %p, %.17g%s);\n", num_levels, offsetjDoubleArray, scale, scale == (int)scale ? ".0" : "");
    ...
    glutSolidSierpinskiSponge(num_levels, jdoubleArrayElements, scale);
