...
JNIEXPORT void JNICALL Java_com_pflager_glu_gluBeginPolygon(JNIEnv *env, jobject object, jobject tessJObject) {
    DPRINTF("gluBeginPolygon(%p);\n", tessJObject);
    ...
    gluBeginPolygon((GLUtesselator*)glutesselator);
}
