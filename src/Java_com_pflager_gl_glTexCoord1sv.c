...
JNIEXPORT void JNICALL Java_com_pflager_gl_glTexCoord1sv(JNIEnv *env, jobject object, jshortArray vJShortArray) {
    DPRINTF("glTexCoord1sv(%p);\n", vJShortArray);
    ...
    glTexCoord1sv(jshortArrayElements);
