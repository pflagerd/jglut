...
JNIEXPORT void JNICALL Java_com_pflager_gl_glMultMatrixf(JNIEnv *env, jobject object, jfloatArray mJFloatArray) {
    DPRINTF("glMultMatrixf(%p);\n", mJFloatArray);
    ...
    glMultMatrixf(jfloatArrayElements);
