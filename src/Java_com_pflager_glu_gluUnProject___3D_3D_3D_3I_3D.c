...
JNIEXPORT jint JNICALL Java_com_pflager_glu_gluUnProject___3D_3D_3D_3I_3D(JNIEnv *env, jobject object, jdoubleArray winXYZJDoubleArray, jdoubleArray modelJDoubleArray, jdoubleArray projJDoubleArray, jintArray viewJIntArray, jdoubleArray objXYZJDoubleArray) {
    DPRINTF("gluUnProject(%p, %p, %p, %p, %p);\n", winXYZJDoubleArray, modelJDoubleArray, projJDoubleArray, viewJIntArray, objXYZJDoubleArray);
